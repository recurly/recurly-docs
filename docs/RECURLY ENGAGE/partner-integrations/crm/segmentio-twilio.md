...
Recurly Engage can consume your existing Segment.com Page (web), Screen (mobile), and Track events by adding an AWS Lambda destination. Once configured, Segment events flow into Recurly Engage as usage traits you can target in prompts.
               ...
               6. Select your app and click "Confirm Source"\
                  ...
                  7. Now go to \[2] and locate the credentials to enter\
                     ...
                     8. Copy over the \`Region\`, \`Role Address\` and \`Lambda ARN\` values. Make sure to provide the read-only \`External ID\` to your customer success manager as the final step. Note that \`Client Context\` and \`Log Type\` do not need any special configuration. &#x20;
                        &#x20;  !\[Settings→Integrations]\(https\://files.readme.io/a036acc-Segment\_configure\_7.png)\<br> &#x20;
                        &#x20;  !\[Settings→Integrations]\(https\://files.readme.io/a6f4a75-Segment\_Configure\_8.png) &#x20;
...
1. Go to **Settings > Usage Tracking > Segment > Add New Tracker**\
   ...
   2. Select a Segment event\
      ...
      3. Go to **Segments > New Segment** and choose the **Usage** tab\
