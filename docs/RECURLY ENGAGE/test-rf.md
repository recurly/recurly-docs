  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        ...
        .rfmodal-message - Prompt message .rfmodal-footer - Buttons Container
      </td>

      <td style={{ textAlign: "left" }}>
        .mweb-widget-msg-container - Text Container .rfmodal-header-mobileweb - Prompt Title .rfmodal-message-mobileweb - Prompt Message .rfmodal-footer-mobileweb - Prompt Buttons Container
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        .rfmodal-text-container - Text Container .rfmodal-header - Prompt title
        .rfmodal-message - Prompt message
        .rfmodal-footer - Buttons Container
      </td>
