...
1. **Navigate** to the Reports section and select the desired report from the available options.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a4ad3bf-image.png",null,""],"align":"center","sizing":"50% ","border":true}]}[/block]
...
5. **Select** the desired requirements for the report and click on the Run button to generate the report.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/ff0517e-image.png",null,""],"align":"center","border":true}]}[/block]

6. **Once** the report is generated, click on the Download Icon to download the report in your preferred format.

   [block:image]{"images":[{"image":["https://files.readme.io/74e51b9-image.png",null,""],"align":"center","border":true}]}[/block]
...
5. The layout is now saved. To access it, click on the drop-down menu in the upper left corner next to Search. Your saved layouts will be listed there.
