...
4. **Prepare the Recurly Site**: Set up and configure your non-Production Recurly site with the necessary custom fields, currencies, coupon settings, and site configurations.
