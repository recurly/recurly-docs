...
* **Credit Card Expired**: Alerts users with an expired credit card before the next bill date.
...
| Field                               | Description                                                        |
| ----------------------------------- | ------------------------------------------------------------------ |
| `{{next_ramp_interval_start_date}}` | The date when your customer’s next pricing interval begins.        |
| `{{next_ramp_interval_price}}`      | The price that will be applied at the start of that next interval. |
