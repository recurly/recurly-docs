...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/dfc1567-Screen_Shot_2016-08-12_at_5.59.14_PM.png",
        "Screen Shot 2016-08-12 at 5.59.14 PM.png",
        584
      ],
      "align": "center",
      "sizing": "50% ",
      "border": true,
      "caption": "The Account Summary, which appears on the right of the Account Details page. It shows shipping addresses and provides a link to the \"manage addresses\" page where you can create, edit and delete shipping addresses."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ad1499-Screen_Shot_2016-08-16_at_6.44.16_PM.png",
        "Screen Shot 2016-08-16 at 6.44.16 PM.png",
        1505
      ],
      "align": "center",
      "sizing": "smart",
      "border": true,
      "caption": "The Shipping Addresses page showing two shipping addresses, their associated subscriptions, the billing and account addresses, plus ways to create a new shipping address, or edit or delete one of the existing shipping addresses."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4564703-Screen_Shot_2016-08-18_at_10.46.37_AM.png",
        "Screen Shot 2016-08-18 at 10.46.37 AM.png",
        2370
      ],
      "align": "center",
      "border": true,
      "caption": "The New Subscription page showing the shipping address drop-down and the Summary section on the right which shows the estimated taxes based on the selected shipping address."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0a1b00a-Screen_Shot_2016-08-18_at_10.52.02_AM.png",
        "Screen Shot 2016-08-18 at 10.52.02 AM.png",
        2374
      ],
      "align": "center",
      "border": true,
      "caption": "The Account Details page showing subscriptions, the shipping address associated with each subscription, and the estimated taxes which are based on the shipping address (when applicable)."
    }
  ]
}
[/block]
