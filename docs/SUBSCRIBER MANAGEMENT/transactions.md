...
title: Transactions
excerpt: >-
  Dive into the intricacies of transactions in the modern commerce era with
  Recurly. From online to over-the-phone, we've got your every transactional
  need covered.
deprecated: false
hidden: false
metadata:
...
In the evolving landscape of commerce, not all transactions occur with a click. [MOTO](https://docs.recurly.com/docs/moto-transactions), or Mail Order / Telephone Order transactions, remain a significant segment, especially for services or clientele that prefer personalized interaction or are not tech-savvy. Recurly’s platform ensures these transactions are seamless, secure, and efficient, bridging the gap between traditional and modern payment methods.