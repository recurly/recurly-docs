...
excerpt: >-
  Address voluntary churn head-on with tailored strategies. Enhance customer
  satisfaction, retain more subscribers, and understand the reasons behind
  departures.
deprecated: false
hidden: false
metadata:
...
Introduce the option for customers to [pause ](https://docs.recurly.com/docs/pause-subscription)their subscriptions instead of outright canceling. This provides flexibility for those who might be facing temporary challenges or changes in circumstances, allowing them to return when they're ready without the hassle of re-subscribing.