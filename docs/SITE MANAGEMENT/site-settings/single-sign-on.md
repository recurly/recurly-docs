...
- **User Provisioning:** Recurly does not natively support user provisioning through your SSO Identity Provider (IdP). This means you will need to manually add new users to Recurly before they can use SSO to log in and authenticate. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/59de449-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9836171-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/497d725-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ed8616-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7d2257f-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5e97bdf-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b41aa90-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d795b1d-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6be0aa4-image.png",
        null,
        ""
      ],
      "align": "center",
...
1. Navigate back to the Admin console, and go to "Apps > Web and mobile apps". Select the newly created SAML app.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/1e046ff-image.png",null,""],"align":"center","border":true}]}[/block]

2. Click "User access".

   [block:image]{"images":[{"image":["https://files.readme.io/43fdede-image.png",null,""],"align":"center","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4893b52-image.png",
        null,
        ""
      ],
      "align": "center",
...
- **Set** "SAML Issuer ID" to <https://app.recurly.com> the same value entered in the "Entity ID" field during step 5 of configuring the custom SAML app.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8103f2b-image.png",
        null,
        ""
      ],
      "align": "center",
...
3. The user can then log back into Recurly by:
   ...
   - Navigating to <http://app.recurly.com/login/sso> directly, or
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7bf0361-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2748851-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/35f385f-first_one.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a584551-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7e9d6b4-the_onenow.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/66eb572-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5c92519-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f4e4d9f-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/563ef76-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e5bd4dd-add_group_dark.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/25c8ae2-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/66d3f59-image.png",
        null,
        ""
      ],
      "align": "center",
...
> **Note:** The group pushed under Push Groups should also not be assigned to the application per Okta Documentation on limitations of Group Push. <https://help.okta.com/oie/en-us/content/topics/users-groups-profiles/usgp-about-group-push.htm>
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a704759-Screenshot_2023-11-07_at_3.23.48_PM.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b545e67-Screenshot_2023-11-07_at_4.51.39_PM.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/16cd1b3-Screenshot_2023-11-07_at_3.24.11_PM.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c7c5ed6-Screenshot_2023-12-12_at_4.57.56_PM.png",
        "",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/13d8b40-image.png",
        null,
        ""
      ],
      "align": "center",
...
**Q: I'm trying to login at <https://app.recurly.com/login> but keep getting an error that the email address or password is incorrect. What should I do?**

**A:** If you're an SSO user, you should be logging in at <https://app.recurly.com/login/sso>, or via your identity provider.

**Q: I'm trying to login at <https://app.recurly.com/login/sso> but keep getting an error that my email address is invalid. How do I solve this?**
