...
| add_on                             | create, update, delete                   | An add on is added to a plan, updated or removed from a plan. **Admin UI only.** Schema notes: Needs update to use measured unit codes.                                                       |
...
| item                               | create, update, disable, enable          | An item is created, updated, disabled or re-enabled on a site. **Admin UI only.**                                                                                                             |
