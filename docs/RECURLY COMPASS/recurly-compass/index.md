...
Upon logging into Recurly, the Welcome page presents AI-driven insights derived from your transactional data. Anomaly detection highlights transactional issues requiring your review.
...
The absence of anomalies may be due to no detection of anomalous data or an insufficient period of baseline data.
