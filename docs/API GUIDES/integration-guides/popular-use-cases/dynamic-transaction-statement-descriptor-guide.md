...
This guide shows you how to use the Purchase, Subscription, and Subscription Update endpoints to customize customer-facing statement descriptors using the Recurly V3 API.  
