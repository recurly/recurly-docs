...
* Note: The Javascript SDK is automatically installed on the [Hosted Account Management](https://docs.recurly.com/recurly-subscriptions/docs/hosted-account-management#/) and [Recurly Checkout](https://docs.recurly.com/recurly-subscriptions/docs/checkout#/) pages.
