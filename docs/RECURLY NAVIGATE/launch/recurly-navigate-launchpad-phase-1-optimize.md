...
Welcome to the first course in Launchpad, a self-paced, comprehensive success plan designed to help you build a strong foundation in Recurly. The full program is structured into two strategic phases — Phase One: Optimization and Phase Two: Mastering your metrics. 
...
<Accordion title="Week 1: Know where to go">
  ...
  You're officially in production and ready to launch. This section will ensure you are comfortable within the Recurly App User Interface and know where to find essential support and resources.
