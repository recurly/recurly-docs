...
.rc-completion { background: #0D0D0B !important; border: 2px solid #FFD706; border-radius: 16px; padding: 40px 36px; text-align: center; margin-bottom: 48px; }
...
.rc-guide a.rc-completion-btn-primary { background: #FFD706 !important; color: #0D0D0B !important; text-decoration: none !important; padding: 12px 24px; border-radius: 10px; font-weight: 800; font-size: .9rem; display: inline-flex; align-items: center; gap: 8px; border: 2px solid #FFD706 !important; transition: all .2s; }
.rc-guide a.rc-completion-btn-primary { border-bottom: 2px solid #FFD706 !important; }
.rc-guide .rc-completion-btn-primary:hover { background: transparent !important; color: #FFD706 !important; border: 2px solid #FFD706 !important; border-bottom: 2px solid #FFD706 !important; }
...
.rc-guide a.rc-completion-btn-secondary { border-bottom: 2px solid rgba(204,201,184,0.35) !important; }
.rc-guide .rc-completion-btn-secondary:hover { border-color: #CCC9B8 !important; border-bottom-color: #CCC9B8 !important; color: #FFFDF2 !important; }
@media(max-width:768px){ .rc-completion { padding: 28px 20px; } .rc-completion-actions { flex-direction: column; align-items: center; } }

/* Dashboard recap — 2-col feature cards */
.rc-card-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin: 0 0 16px; }
...
/* Metrics grid — 3-col */
.rc-metrics-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 14px; margin: 0 0 32px; }
.rc-metric-card { background: var(--offwhite); border: 1px solid var(--lightgray); border-radius: 14px; padding: 20px; text-align: center; }
.rc-metric-icon { font-size: 1.6rem; margin-bottom: 8px; }
.rc-metric-card h5 { font-size: .8rem; font-weight: 800; color: var(--offblack); margin: 0 0 6px; text-transform: uppercase; letter-spacing: .6px; }
.rc-metric-card p { font-size: .82rem; color: var(--gray); line-height: 1.5; margin: 0; }
@media(max-width:768px){ .rc-metrics-grid { grid-template-columns: 1fr; } }
...
.rc-next-card:hover { border-color: #FF5810; box-shadow: 0 4px 16px rgba(255,88,16,0.15); transform: translateY(-2px); }
...
/* Path nav — last page uses completion state */
  ...
  <div class="rc-content-wrap">
    ...
    <details class="rc-sticky-nav-wrap">
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-payments-hub-review-resources" class="rc-sticky-link rc-sticky-link-active"><span class="rc-step-badge">6</span> Review &amp; resources</a>
    ...
    <!-- Path nav — last page: completion state -->
    <div class="rc-lp-nav">
