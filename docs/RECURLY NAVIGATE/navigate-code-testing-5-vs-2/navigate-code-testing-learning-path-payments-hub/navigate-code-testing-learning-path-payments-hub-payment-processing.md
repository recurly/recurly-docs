...
/* Host-theme armor — neutralises ReadMe's global link border-bottom/underline.
   Button and resource hover rules use .rc-guide prefix to outrank this. */
.rc-guide a,
.rc-guide a:link,
.rc-guide a:visited,
.rc-guide a:hover,
...
/* Path nav — a.rc-btn-* for base border-bottom, .rc-guide prefix on hover */
  ...
  <div class="rc-content-wrap">
    ...
    <details class="rc-sticky-nav-wrap">
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-payments-hub-payment-processing" class="rc-sticky-link rc-sticky-link-active"><span class="rc-step-badge">2</span> Payment processing</a>
