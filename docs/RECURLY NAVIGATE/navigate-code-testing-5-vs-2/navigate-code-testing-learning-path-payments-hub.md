---
title: Navigate Code Testing Learning Path Payments Hub
deprecated: false
hidden: true
metadata:
  robots: index
...
/* Webinar CTA — dark card, !important required per ReadMe constraint */
...
@media(max-width:768px){
  ...
  .rc-hero-stat + .rc-hero-stat { border-left: none; border-top: 1px solid rgba(255,255,255,0.12); padding-top: 16px; margin-top: 16px; }
}
</style>
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
    ...
    <!-- Sticky nav — overview page active -->
    ...
    <!-- Section 1: What is Payments Hub? -->
    ...
    <!-- Section 4: Watch the full walkthrough -->
    <div class="rc-lp-section">
