...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    /* Hero */
    .rc-hero{background:var(--offblack);color:white;padding:56px 40px 48px;text-align:center;border-radius:16px;margin-bottom:24px;}
    ...
    .rc-hero h1{font-size:2.4rem;font-weight:800;line-height:1.15;margin-bottom:14px;color:#FFFDF2;}
    ...
    /* Tab Nav */
    .rc-tabs{display:flex;flex-wrap:wrap;gap:0;border-bottom:2px solid var(--lightgray);margin-bottom:32px;}
    .rc-tab-btn{padding:10px 16px;font-size:0.85rem;font-weight:700;color:var(--gray);background:none;border:none;border-bottom:3px solid transparent;margin-bottom:-2px;cursor:pointer;transition:color 0.2s,border-color 0.2s;white-space:nowrap;}
    .rc-tab-btn:hover{color:var(--offblack);}
    .rc-tab-btn.active{color:var(--offblack);border-bottom-color:var(--yellow);}

    /* Pages */
    .rc-page{display:none;}
    ...
    .rc-btn-prev,.rc-btn-next,.rc-btn-disabled{display:inline-flex;align-items:center;justify-content:center;padding:11px 18px;border-radius:10px;font-weight:700;font-size:0.88rem;border:1px solid var(--lightgray);cursor:pointer;}
    ...
    /* Footer */
    .rc-footer{margin-top:48px;padding-top:24px;border-top:1px solid var(--lightgray);}
    ...
    @media(max-width:640px){
      ...
      .rc-tabs{gap:4px;}
      .rc-tab-btn{padding:8px 10px;font-size:0.78rem;}
...
<body>
  ...
  <!-- TAB NAV -->
  <div class="rc-tabs">
    <button class="rc-tab-btn active" onclick="showPage(0)">🧭 Intro</button>
    <button class="rc-tab-btn" onclick="showPage(1)">🏷️ Subscription Plans</button>
    <button class="rc-tab-btn" onclick="showPage(2)">🛍️ Storefront Setup</button>
    <button class="rc-tab-btn" onclick="showPage(3)">👤 Customer Portal</button>
    <button class="rc-tab-btn" onclick="showPage(4)">🔔 Notifications</button>
    <button class="rc-tab-btn" onclick="showPage(5)">🔗 Integrations</button>
    <button class="rc-tab-btn" onclick="showPage(6)">🚀 Launch!</button>
  </div>

  <!-- PAGE 0: INTRO -->
  <div class="rc-page active" id="page-0">
    ...
    <div class="rc-sec-nav">
      ...
      <button class="rc-btn-next" onclick="showPage(1)">Next: Subscription Plans →</button>
    </div>
  </div>

  <!-- PAGE 1: SUBSCRIPTION PLANS -->
  <div class="rc-page" id="page-1">
    <div class="rc-sec-header">
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(0)">← Intro</button>
      <button class="rc-btn-next" onclick="showPage(2)">Next: Storefront Setup →</button>
    </div>
  </div>

  <!-- PAGE 2: STOREFRONT SETUP -->
  <div class="rc-page" id="page-2">
    <div class="rc-sec-header">
      <div class="rc-sec-icon">🛍️</div>
      <div>
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(1)">← Plans</button>
      <button class="rc-btn-next" onclick="showPage(3)">Next: Customer Portal →</button>
    </div>
  </div>

  <!-- PAGE 3: CUSTOMER PORTAL -->
  <div class="rc-page" id="page-3">
    <div class="rc-sec-header">
      <div class="rc-sec-icon">👤</div>
      <div>
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(2)">← Storefront</button>
      <button class="rc-btn-next" onclick="showPage(4)">Next: Notifications →</button>
    </div>
  </div>

  <!-- PAGE 4: NOTIFICATIONS -->
  <div class="rc-page" id="page-4">
    <div class="rc-sec-header">
      <div class="rc-sec-icon">🔔</div>
      <div>
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(3)">← Customer Portal</button>
      <button class="rc-btn-next" onclick="showPage(5)">Next: Integrations →</button>
    </div>
  </div>

  <!-- PAGE 5: INTEGRATIONS -->
  <div class="rc-page" id="page-5">
    <div class="rc-sec-header">
      <div class="rc-sec-icon">🔗</div>
      <div>
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(4)">← Notifications</button>
      <button class="rc-btn-next" onclick="showPage(6)">Next: Launch! →</button>
    </div>
  </div>

  <!-- PAGE 6: LAUNCH -->
  <div class="rc-page" id="page-6">
    ...
    <div class="rc-sec-nav">
      <button class="rc-btn-prev" onclick="showPage(5)">← Integrations</button>
  ...
  <script>
    function showPage(n) {
      document.querySelectorAll('.rc-page').forEach(function(p) { p.classList.remove('active'); });
      document.querySelectorAll('.rc-tab-btn').forEach(function(b) { b.classList.remove('active'); });
      document.getElementById('page-' + n).classList.add('active');
      document.querySelectorAll('.rc-tab-btn')[n].classList.add('active');
