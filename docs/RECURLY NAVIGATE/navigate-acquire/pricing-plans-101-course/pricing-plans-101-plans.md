...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
      ...
      <div class="rc-steps">
        ...
        <div class="rc-step">
          ...
          <div class="rc-step-content">
            ...
            <p>Enter the price per billing period. Choose your pricing model — fixed, ramp, or usage-based. Pricing models are covered in detail on the <strong>Pricing models</strong> page of this course.</p>
          </div>
        </div>
        <div class="rc-step">
    ...
    <!-- Section: Things to decide before you build -->
    <div class="rc-lp-section">
    ...
    <!-- Path nav -->
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101" class="rc-btn-prev">← Overview</a>
