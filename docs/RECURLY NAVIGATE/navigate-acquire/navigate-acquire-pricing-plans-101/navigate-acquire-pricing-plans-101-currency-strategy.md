  ...
  <div class="rc-content-wrap">
    ...
    <details class="rc-sticky-nav-wrap" open>
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101-currency" class="rc-sticky-link"><span class="rc-step-badge">1</span> Currency: Overview</a>
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101-currency-strategy" class="rc-sticky-link rc-sticky-link-active">
          <img src="https://files.readme.io/27c852ebfd8736eb0017ee9442030e66cd19e7db48c7e791ec5d8e092162ca48-White_Navigate_Home_Pin_1.png" alt=""> Currency: Strategy
        </a>
    ...
    <!-- Pricing strategy -->
    <div class="rc-lp-section" id="pricing-strategy">
      <h2>💱 From multi-currency enabled to multi-currency optimised</h2>
      <p>Most merchants who enable multi-currency do the minimum: they convert their USD price to local currency and call it done. The merchants who see the acquisition lift go one step further — they treat each market's pricing as its own decision, informed by local purchasing power, competitive benchmarks, and psychological pricing norms.</p>

      <div class="rc-steps">
        <div class="rc-step">
          <div class="rc-step-num">1</div>
          <div class="rc-step-content">
            <h4>Price for the market, not the exchange rate</h4>
            <p>A mathematical conversion of your USD price almost never produces the right local price. €10.43 looks like an afterthought. €9.99 looks like a deliberate pricing decision. <strong>Localised price points — ending in .99, .95, or round numbers that match local market conventions</strong> — consistently outperform auto-converted prices in A/B tests across European and APAC markets.</p>
            <p>Research what your category costs in each target market. Your competitors who are native to that market have already set subscriber price expectations — your pricing needs to be legible and competitive within that context.</p>
          </div>
        </div>
        <div class="rc-step">
          <div class="rc-step-num">2</div>
          <div class="rc-step-content">
            <h4>Offer the right payment methods alongside the right currency</h4>
            <p>Currency and payment method are different levers — but they need to be aligned. EMEA subscribers who see euro pricing but can only pay by credit card are still experiencing friction. PayPal accounts for 27.7% of EMEA transactions on the Recurly platform. If you're serving European subscribers, enabling PayPal alongside local currency pricing will meaningfully improve conversion.</p>
            <p>Match payment method availability to your gateway's capabilities in each market, and confirm that your Recurly Checkout configuration surfaces the right payment options for each currency region.</p>
          </div>
        </div>
        <div class="rc-step">
          <div class="rc-step-num">3</div>
          <div class="rc-step-content">
            <h4>Build region-aware dunning logic</h4>
            <p>EMEA subscribers are twice as likely to fail at renewal than at signup. U.S. subscribers are twice as likely to fail at signup than at renewal. These patterns have direct implications for your dunning strategy. <strong>A single dunning campaign applied globally will underperform for both regions.</strong></p>
            <p>For EMEA plans: extend your renewal dunning window, include a pre-renewal email prompting subscribers to verify their payment method, and configure Account Updater if your gateway supports it. For U.S. plans: invest in pre-authorization during trials and first-payment retry logic. Your Plans path covers dunning assignment at the plan level — use it per market.</p>
          </div>
        </div>
        <div class="rc-step">
          <div class="rc-step-num">4</div>
          <div class="rc-step-content">
            <h4>Lock currency at checkout for single-market plans</h4>
            <p>If a plan is designed for a specific market, prevent price comparison by locking the checkout to a single currency. A subscriber who discovers they can switch to USD pricing and pay less in their local equivalent will do exactly that — and you've effectively created an unintended discount channel.</p>
            <p>Configure this in your Recurly Checkout settings by creating a separate checkout configuration per market, each locked to the appropriate currency. For HPP-based checkouts, pass the currency parameter in the HPP URL to force the correct currency.</p>
          </div>
        </div>
        <div class="rc-step">
          <div class="rc-step-num">5</div>
          <div class="rc-step-content">
            <h4>Monitor decline rates by currency in Analytics</h4>
            <p>Recurly's transaction exports include currency codes — use them. Pull a monthly report of decline rates segmented by currency to identify regional patterns that your global decline rate will hide. A spike in EUR renewal failures in Q4 (when EMEA consumers shift spending toward the holidays) requires a different response than a spike in USD signup failures driven by prepaid card usage.</p>
          </div>
        </div>
      </div>
    </div>

    <!-- Currency readiness checklist -->
    <div class="rc-lp-section" id="audit">
      <h2>🔍 Multi-currency readiness checklist</h2>
      <p>Whether you're setting up multi-currency for the first time or auditing an existing configuration, these are the signals that tell you if your setup is working as intended.</p>

      <div class="rc-checklist">
        <div class="rc-checklist-header">
          <span style="font-size:1rem;">🌍</span>
          <h4>Currency configuration health check</h4>
        </div>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>All currency prices are localised — not mathematically converted</strong>
            <span>€10.43 is a red flag. €9.99 is a pricing decision. Review every plan's non-USD prices.</span>
          </div>
        </label>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>Gateway supports all enabled currencies — confirmed, not assumed</strong>
            <span>Log in to your gateway dashboard and verify. Don't rely on Recurly's currency enablement as proof the gateway will process it.</span>
          </div>
        </label>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>All plans and add-ons have prices in every enabled currency</strong>
            <span>A plan without a currency price won't show at checkout for subscribers in that region. Run an audit across all active plans.</span>
          </div>
        </label>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>3DS / SCA is configured for EUR and GBP checkouts</strong>
            <span>European card transactions require Strong Customer Authentication. Skipping this means high decline rates on legitimate transactions.</span>
          </div>
        </label>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>EMEA subscribers have PayPal available as a payment method</strong>
            <span>27.7% of EMEA transactions use PayPal. If your checkout doesn't surface it, you're losing a meaningful slice of that market.</span>
          </div>
        </label>
        <label class="rc-checklist-item">
          <input type="checkbox">
          <div class="rc-checkbox-box"></div>
          <div class="rc-checklist-text">
            <strong>I monitor decline rates by currency monthly</strong>
            <span>Your global decline rate masks regional patterns. Pull transaction exports and segment by currency code.</span>
          </div>
        </label>
    ...
    <div class="rc-lp-section" id="ai-strategy">
      <h2>🤖 Currency strategy in the AI era</h2>
      <p>AI assistants that compare subscriptions across providers are increasingly doing so on a global basis — evaluating options for subscribers regardless of where the provider is headquartered. How your pricing appears in non-native markets matters more than it used to.</p>

      <div class="rc-steps">
        <div class="rc-step">
          <div class="rc-step-num-q">Q</div>
          <div class="rc-step-content">
            <h4>"Does local currency pricing affect how AI assistants surface my subscription?"</h4>
            <p>Yes — indirectly. AI assistants answering questions like "best project management subscription for UK teams" will surface pricing in GBP if it's available and clearly stated. If your pricing page only shows USD, the AI either converts it (introducing the same friction you're trying to avoid) or deprioritises your result in favour of a provider with localised pricing.</p>
            <p><strong>Localised pricing on your public-facing pages — not just in Recurly — is what AI models retrieve.</strong> Make sure your pricing page, landing pages, and any third-party review sites show GBP, EUR, and AUD pricing for the markets you serve.</p>
          </div>
        </div>
        <div class="rc-step">
          <div class="rc-step-num-q">Q</div>
          <div class="rc-step-content">
            <h4>"How do I use data to decide which currencies to prioritise?"</h4>
            <p>Start with your existing traffic and transaction data. Export your Recurly transactions and look at which countries your subscribers are already coming from — in your default currency. Those are your highest-priority localisation markets, because subscribers are already converting despite the friction of foreign-currency pricing.</p>
            <p>Use an AI tool to analyse the export: "which countries have the highest number of transactions in USD where the subscriber's billing address is not the US?" That list is your multi-currency roadmap. The markets where subscribers are already paying in a non-local currency represent your biggest conversion opportunity with the lowest customer acquisition cost.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="rc-pitch-card">
      ...
      <h3>Currency is a conversion decision</h3>
      <p class="rc-pitch-quote">"The subscriber who sees their local currency at checkout is <strong>already more likely to complete the purchase.</strong> You haven't changed your product — you've just removed one more reason to hesitate."</p>
    </div>
    ...
    <div class="rc-lp-section">
      ...
      <div class="rc-steps">
        <div class="rc-step">
          ...
          <div class="rc-step-content">
            <h4>If you look at your subscriber map today, which countries have subscribers paying in your default currency — and what would your conversion rate look like if those subscribers had seen their local currency at checkout instead?</h4>
            <p>This question often reveals the multi-currency opportunity hiding in plain sight. Subscribers who convert despite foreign-currency friction are your most motivated buyers — but they represent only a fraction of the audience who saw the same friction and left. The gap between those two numbers is your localisation opportunity.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- OH CTA -->
    <div class="rc-oh-cta">
      <h4>🗓️ Questions about currency setup or regional strategy?</h4>
      <p>Our Customer Success team runs weekly <strong>Global Office Hours</strong> where you can bring specific questions about gateway configuration, localisation strategy, or regional decline patterns. No agenda required.</p>
    ...
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101-currency-configure" class="rc-btn-prev">← Configure</a>
      <span class="rc-lp-nav-indicator">3 of 3 · Currency</span>
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101-pricing-models" class="rc-btn-path">Continue to Pricing Models →</a>
    </div>
