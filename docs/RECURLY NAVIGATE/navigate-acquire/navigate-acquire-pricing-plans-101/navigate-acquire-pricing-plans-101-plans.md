...
excerpt: /navigate-acquire-pricing-plans-101-plans
deprecated: false
hidden: true
metadata:
  title: Recurly Plans Overview
  robots: index
---
<HTMLBlock>{`
<style>
...
<div class="rc-guide">
  ...
  <div class="rc-top-nav">
    <!-- Micro-Path back link always returns to Learning Path overview -->
  ...
  <div class="rc-content-wrap">
    ...
    <!-- Navigation Menu — non-sticky, open, Micro-Path variant
         Items: Navigate Home → Plans pages (active has map pin) → Back to Path Start -->
    <details class="rc-sticky-nav-wrap" open>
      <summary>
        <span class="rc-nav-toggle-label">Navigation Menu <span class="rc-nav-chevron">▲</span></span>
      </summary>
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        <!-- Navigate Home — always first, black home icon on yellow nav -->
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101-plans" class="rc-sticky-link rc-sticky-link-active">
          <img src="https://files.readme.io/070e914d23dead09604d5f96b8769c88b8aae704ebd4505415e5854011030110-Black_Navigate_Home_Pin_1.png" alt=""> Plans: Overview
        </a>
        ...
        <!-- Back to Path Start — always last, circle arrow icon -->
    ...
    <!-- Path nav -->
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-101" class="rc-btn-prev">← Pricing & Packaging 101</a>
