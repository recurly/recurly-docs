  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-lp-section">
      ...
      <div class="rc-callout rc-callout-caution">
        ...
        <div class="rc-callout-body">
          ...
          <p>Account Hierarchy, Invoice Rollup, and Analytics Explore are available on the Recurly Elite plan. Usage billing requires an API integration. These are flagged on the relevant pages so you know what to plan for before diving in.</p>
        </div>
      </div>
    </div>
      ...
      <div class="rc-toc-list">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-201-segmentation" class="rc-toc-card">
          ...
          <div class="rc-toc-body">
            ...
            <p>Charge different prices to different subscriber segments — by geography, cohort, or acquisition channel — using a single plan instead of duplicate configurations.</p>
          </div>
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-201-hierarchy" class="rc-toc-card">
          ...
          <div class="rc-toc-body">
            ...
            <p>Structure parent and child accounts for B2B and enterprise customers — with per-child billing responsibility, consolidated invoicing via Invoice Rollup, and full API visibility.</p>
          </div>
          <div class="rc-toc-arrow">→</div>
        </a>
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-201-advanced-models" class="rc-toc-card">
          ...
          <div class="rc-toc-body">
            ...
            <p>Build hybrid pricing architectures that combine a base subscription with usage, quantity-based, or one-time charges on a single invoice — and explore prepaid account balance billing, where customers pay upfront and draw down their balance over time.</p>
          </div>
          <div class="rc-toc-arrow">→</div>
        </a>
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-acquire-pricing-plans-201-review" class="rc-toc-card">
    ...
    <div class="rc-resources">
      ...
      <div class="rc-resource-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/billing-models" target="_blank" rel="noopener noreferrer" class="rc-resource-link"><i class="fa-regular fa-file-lines"></i> Recurly Docs: Pricing models</a>
