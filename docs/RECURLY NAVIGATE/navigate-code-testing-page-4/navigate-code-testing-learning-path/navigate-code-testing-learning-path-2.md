---
title: Navigate Code Testing Learning Path 2
deprecated: false
hidden: true
metadata:
  robots: index
...
<title>Account Updater: Why Use It? — Recurly Navigate</title>
<style>
...
.rc-benefit-icon { font-size: 1.4rem; line-height: 1; }
.rc-benefit-card h4 { font-size: .98rem; font-weight: 800; color: var(--offblack); margin: 0; }
.rc-benefit-card p { font-size: .88rem; color: var(--gray); line-height: 1.55; margin: 0; flex-grow: 1; }
.rc-benefit-tag {
...
@media(max-width:768px){
  ...
  .rc-benefit-grid { grid-template-columns: 1fr; }
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
      ...
      <div class="rc-nav-drawer">
        <div class="rc-nav-drawer-inner">
          <div class="rc-nav-links">
            ...
            <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-benefits" class="rc-sticky-link rc-sticky-link-active"><span class="rc-step-badge">1</span> Why use it?</a>
    ...
    <div class="rc-lp-section">
      ...
      <div class="rc-benefit-grid">
        <div class="rc-benefit-card">
          <div class="rc-benefit-icon">🛡️</div>
          ...
          <span class="rc-benefit-tag">Proactive Recovery</span>
        </div>
        <div class="rc-benefit-card">
          <div class="rc-benefit-icon">💸</div>
          ...
          <span class="rc-benefit-tag">Lower OpEx</span>
        </div>
        <div class="rc-benefit-card">
          <div class="rc-benefit-icon">🤝</div>
          ...
          <span class="rc-benefit-tag">CX Improvement</span>
        </div>
        <div class="rc-benefit-card">
          <div class="rc-benefit-icon">🔁</div>
          ...
          <span class="rc-benefit-tag">Integrated Logic</span>
        </div>
      </div>
