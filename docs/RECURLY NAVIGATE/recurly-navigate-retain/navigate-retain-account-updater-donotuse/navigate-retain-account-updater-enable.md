...
<div class="rc-guide">
  <div class="rc-hero">
    ...
    <p class="rc-subtitle">Step-by-step activation guide.</p>
  ...
  <div class="rc-nav">
    ...
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-enable" class="is-active"><span class="rc-snum">5</span> How to Enable It</a>
  ...
  <div class="rc-sec">
    <div class="rc-sec-header">
      <div class="rc-sec-icon"><img src="https://drive.google.com/thumbnail?sz=w200&id=1spkzqq7q_IQuxDwLVmw2tFtrL3XQ3JWp" alt="tool icon" style="width:28px;height:28px;"></div>
      <div><h2>How to Enable Account Updater</h2><p>Step-by-step activation in your Recurly environment.</p></div>
    </div>

    <div class="rc-card">
      <h3>Activation Path</h3>
      <p>Enabling Account Updater involves coordination between your team and Recurly support. Activation typically takes 2–5 business days.</p>
    </div>

    <div class="rc-subhead">Step-by-Step Enablement Process</div>
    <div class="rc-steps">
      <div class="rc-step"><div class="rc-sbadge">1</div><div class="rc-step-content"><h4>Verify Gateway Support</h4><p>Ensure your gateway (Stripe, Braintree, Adyen, etc.) supports the feature.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">2</div><div class="rc-step-content"><h4>Enable with Gateway</h4><p>Contact your provider to ensure Account Updater is active on your merchant account.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">3</div><div class="rc-step-content"><h4>Submit Recurly Request</h4><p>Email support@recurly.com with your site subdomain and gateway name.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">4</div><div class="rc-step-content"><h4>Recurly Configuration</h4><p>Support team links the engine and configures update cadence.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">5</div><div class="rc-step-content"><h4>Validate</h4><p>Allow one full billing cycle to see results appearing in your dashboard.</p></div></div>
    </div>

    <div class="rc-checklist">
      <div class="rc-cl-header">Account Updater Enablement Checklist</div>
      <div class="rc-cli"><input type="checkbox" class="rc-cb" id="au1"><label for="au1">Verified Account Updater is enabled on gateway portal</label></div>
      <div class="rc-cli"><input type="checkbox" class="rc-cb" id="au2"><label for="au2">Sent enablement request to support@recurly.com</label></div>
    </div>
  </div>

  <div class="rc-sec-nav">
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-fit" class="rc-btn-prev">← Previous</a>
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-data" class="rc-btn-next">Next →</a>
  </div>
</div></div></body></html>
`}</HTMLBlock>
