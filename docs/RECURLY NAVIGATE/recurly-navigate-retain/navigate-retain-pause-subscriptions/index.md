...
<HTMLBlock>{`
<style>
.rc-guide { font-family: "Inter", -apple-system, sans-serif; color: #0D0D0B; max-width: 900px; margin: 0 auto; background: #F5F5F0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08); }
...
.rc-tip { border-left: 4px solid #FFD706; background: #FFFFFF; padding: 20px 24px; border-radius: 0 12px 12px 0; margin: 20px 0; border: 1px solid #CCC9B8; border-left-width: 4px; border-left-color: #FFD706; }
  ...
  <div class="rc-sec">
    ...
    <div class="rc-step">
      ...
      <div style="flex:1;">
        ...
        <p style="margin:0; font-size:14px; color:#32312D;">A pause can be triggered via self-service, the Admin Console, or the Recurly API.</p>
      </div>
    </div>
    ...
    <div class="rc-step">
      ...
      <div style="flex:1;">
        ...
        <p style="margin:0; font-size:14px; color:#32312D;">The pause starts at the end of the current billing period—ensuring the subscriber gets the full value of what they've paid for.</p>
      </div>
    </div>
