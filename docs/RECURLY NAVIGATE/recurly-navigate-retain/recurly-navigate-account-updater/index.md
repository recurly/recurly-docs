...
<div class="rc-guide">
  ...
  <nav class="rc-nav">
    <a class="is-active" href="https://docs.recurly.com/recurly-subscriptions/docs/recurly-navigate-account-updater"><span class="rc-snum">1</span>What Is It?</a>
  ...
  <div class="rc-sec">
    ...
    <div class="rc-sec-nav">
      <span class="rc-btn-disabled">🎯 Start: Account Updater</span>
      <a class="rc-btn-next" href="https://docs.recurly.com/recurly-subscriptions/docs/why-use-it">Next: Why Use It? →</a>
    </div>
    ...
    <a class="rc-link-btn rc-link-sec" href="https://docs.recurly.com/recurly-subscriptions/docs/how-to-enable-it">⚙️ How to Enable It</a>
