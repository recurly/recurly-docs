...
<div class="rc-guide">
  <div class="rc-hero">
    ...
    <p class="rc-subtitle">Learn when Account Updater might not be the right fit.</p>
  ...
  <div class="rc-nav">
    ...
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-fit" class="is-active"><span class="rc-snum">4</span> When Not to Use It</a>
  ...
  <div class="rc-sec">
    <div class="rc-sec-header">
      <div class="rc-sec-icon"><img src="https://drive.google.com/thumbnail?sz=w200&id=1wcvg3Ufxub3-78NL1HaxIBh01CLx5f5W" alt="bell icon" style="width:28px;height:28px;"></div>
      <div><h2>When Not to Use Account Updater</h2><p>Understand the service limitations and scenarios where it doesn't apply.</p></div>
    </div>

    <div class="rc-card">
      <h3>Account Updater Has Limits</h3>
      <p>Account Updater excels at keeping card credentials current, but it is not a silver bullet for all payment failures.</p>
    </div>

    <div class="rc-subhead">Scenarios Where Account Updater Won't Help</div>
    <div class="rc-steps">
      <div class="rc-step"><div class="rc-sbadge">1</div><div class="rc-step-content"><h4>Insufficient Funds</h4><p>Account Updater only refreshes credentials. If a transaction fails due to lack of credit, use intelligent retries instead.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">2</div><div class="rc-step-content"><h4>Fraud-Related Declines</h4><p>When an issuer blocks a card for fraud, Account Updater receives a "contact cardholder" flag rather than new details.</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">3</div><div class="rc-step-content"><h4>Non-Card Payment Methods</h4><p>Does not affect ACH, PayPal, Amazon Pay, or Apple Pay (unless tokenized via card network).</p></div></div>
      <div class="rc-step"><div class="rc-sbadge">4</div><div class="rc-step-content"><h4>Closed Accounts</h4><p>If a subscriber closes an account without opening a replacement, only direct outreach can capture a new method.</p></div></div>
    </div>

    <div class="rc-warning"><strong>⚠️ Account Updater Does Not Override Subscriber Intent</strong><p>It prevents <em>involuntary</em> churn. If a subscriber wants to cancel, you must honor that request through standard cancellation flows.</p></div>
  </div>

  <div class="rc-sec-nav">
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-considerations" class="rc-btn-prev">← Previous</a>
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-enable" class="rc-btn-next">Next →</a>
  </div>
</div></div></body></html>
`}</HTMLBlock>
