...
/* ── NAV (non-sticky, open) — Retain pillar ── */
...
.rc-guide a.rc-btn-prev:hover { border: 2px solid var(--offblack) !important; border-bottom: 2px solid var(--offblack) !important; color: var(--offblack) !important; }
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
      ...
      <div class="rc-nav-drawer">
        <div class="rc-nav-drawer-inner">
          <div class="rc-nav-links">
            ...
            <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater" class="rc-sticky-link"><span class="rc-step-badge">1</span> Why use it?</a>
    ...
    <div class="rc-lp-section">
      ...
      <h3 style="font-size: 1rem; font-weight: 800; color: var(--offblack); margin: 28px 0 12px; display: flex; align-items: center; gap: 8px;"><i class="fa-solid fa-list-check rc-fa-section"></i> Key questions to ask before you enable</h3>
      <div class="rc-steps">
        <div class="rc-step">
      ...
      <h3 style="font-size: 1rem; font-weight: 800; color: var(--offblack); margin: 0 0 16px; display: flex; align-items: center; gap: 8px;"><i class="fa-solid fa-bolt rc-fa-section"></i> Quick diagnostic</h3>
      ...
      <h3 style="font-size: 1rem; font-weight: 800; color: var(--offblack); margin: 0 0 16px; display: flex; align-items: center; gap: 8px;"><i class="fa-solid fa-list-check rc-fa-section"></i> Pre-enablement checklist</h3>
    ...
    <!-- PATH NAV BUTTONS -->
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater-benefits" class="rc-btn-prev">← Section 1: Why use it?</a>
