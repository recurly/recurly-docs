...
/* RESOURCES */
.rc-resources { margin: 48px 0 0; }
.rc-resources h3 { font-size: 1.1rem; font-weight: 800; color: var(--offblack); margin: 0 0 16px; display: flex; align-items: center; gap: 10px; }
...
.rc-guide a.rc-footer-link { color: #807D73 !important; text-decoration: none !important; font-weight: 600; font-size: .88rem; border-bottom: 0 !important; transition: color .2s ease; display: inline-flex; align-items: center; gap: 6px; }
  ...
  <div class="rc-content-wrap">
    ...
    <details class="rc-sticky-nav-wrap">
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-dunning-101-window-length" class="rc-sticky-link">Dunning window length</a>
