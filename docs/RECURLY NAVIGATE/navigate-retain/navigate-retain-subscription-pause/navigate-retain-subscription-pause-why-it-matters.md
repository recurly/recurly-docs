...
.rc-accent-card.rc-accent-retain { border-left: 4px solid #FF9D88; }
...
@media(max-width:768px){
  ...
  .rc-stat-tile + .rc-stat-tile { border-left: 0; border-top: 1px solid #CCC9B8; }
}
</style>
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
    ...
    <!-- PATH NAV -->
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-subscription-pause" class="rc-btn-prev">← Overview</a>
