...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #rcSec0:target ~ .rc-nav a[href="#rcSec0"],
  #rcSec1:target ~ .rc-nav a[href="#rcSec1"],
  #rcSec2:target ~ .rc-nav a[href="#rcSec2"],
  #rcSec3:target ~ .rc-nav a[href="#rcSec3"],
  #rcSec4:target ~ .rc-nav a[href="#rcSec4"],
  #rcSec5:target ~ .rc-nav a[href="#rcSec5"],
  #rcSec6:target ~ .rc-nav a[href="#rcSec6"] {
    background: var(--yellow);
    border-color: var(--yellow);
    color: var(--offblack);
  ...
  #rcSec0:target ~ .rc-nav a[href="#rcSec0"] .rc-snum,
  #rcSec1:target ~ .rc-nav a[href="#rcSec1"] .rc-snum,
  #rcSec2:target ~ .rc-nav a[href="#rcSec2"] .rc-snum,
  #rcSec3:target ~ .rc-nav a[href="#rcSec3"] .rc-snum,
  #rcSec4:target ~ .rc-nav a[href="#rcSec4"] .rc-snum,
  #rcSec5:target ~ .rc-nav a[href="#rcSec5"] .rc-snum,
  #rcSec6:target ~ .rc-nav a[href="#rcSec6"] .rc-snum {
    background: var(--offblack);
    color: var(--yellow);
  }

  /* Default active tab = Intro */
  .rc-guide:not(:has(.rc-target:target)) .rc-nav a[href="#rcSec0"] {
    background: var(--yellow);
    border-color: var(--yellow);
    color: var(--offblack);
    box-shadow: 0 2px 10px rgba(255, 215, 6, 0.25);
  ...
  #rcSec0:target ~ .rc-panels .rc-panel,
  #rcSec1:target ~ .rc-panels .rc-panel,
  #rcSec2:target ~ .rc-panels .rc-panel,
  #rcSec3:target ~ .rc-panels .rc-panel,
  #rcSec4:target ~ .rc-panels .rc-panel,
  #rcSec5:target ~ .rc-panels .rc-panel,
  #rcSec6:target ~ .rc-panels .rc-panel {
    display: none;
  }

  #rcSec0:target ~ .rc-panels .rc-panel-0,
  #rcSec1:target ~ .rc-panels .rc-panel-1,
  #rcSec2:target ~ .rc-panels .rc-panel-2,
  #rcSec3:target ~ .rc-panels .rc-panel-3,
  #rcSec4:target ~ .rc-panels .rc-panel-4,
  #rcSec5:target ~ .rc-panels .rc-panel-5,
  #rcSec6:target ~ .rc-panels .rc-panel-6 {
    display: block;
  }
...
<div class="rc-guide">
  ...
  <span id="rcSec0" class="rc-target"></span>
  <span id="rcSec1" class="rc-target"></span>
  <span id="rcSec2" class="rc-target"></span>
  <span id="rcSec3" class="rc-target"></span>
  <span id="rcSec4" class="rc-target"></span>
  <span id="rcSec5" class="rc-target"></span>
  <span id="rcSec6" class="rc-target"></span>
  ...
  <div class="rc-panels rc-container">
    <div class="rc-panel rc-panel-default rc-panel-0">
      <div class="rc-sec">
