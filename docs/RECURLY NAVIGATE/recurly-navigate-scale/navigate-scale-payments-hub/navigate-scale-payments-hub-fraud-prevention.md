...
.rc-complete h2{font-size:1.8rem;font-weight:800;margin:12px 0 10px;color:var(--yellow)}.rc-complete p{color:var(--lightgray);font-size:.95rem;margin:0 0 20px;line-height:1.6}
.rc-complete a{background:var(--yellow);color:var(--offblack);text-decoration:none;padding:12px 24px;border-radius:10px;font-weight:700;font-size:.9rem;display:inline-flex;align-items:center;gap:8px}
...
<div class="rc-guide">
  <div class="rc-hero">
    ...
    <div class="rc-hero-stats">
      <div><div class="rc-num">Kount</div><div class="rc-lbl">Required to see data</div></div>
      <div><div class="rc-num">0–100</div><div class="rc-lbl">Higher score = higher risk</div></div>
      <div><div class="rc-num">2</div><div class="rc-lbl">Trend charts: blocked + score</div></div>
    </div>
  </div>
  ...
  <nav class="rc-nav">
    ...
    <a class="is-active" href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-payments-hub-fraud-prevention"><span class="rc-snum">6</span>Fraud prevention</a>
  </nav>
