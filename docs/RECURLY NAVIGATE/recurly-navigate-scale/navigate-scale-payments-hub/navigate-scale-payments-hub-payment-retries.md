---
title: 'Payments Hub: Payment retries'
deprecated: false
hidden: true
metadata:
  robots: index
...
.rc-warning{background:var(--offblack);border-radius:14px;padding:20px 24px;display:flex;gap:16px;align-items:flex-start;margin-bottom:24px;border:2px solid var(--orange)}
.rc-wicon{font-size:24px;flex-shrink:0}.rc-warning h4{font-size:.82rem;font-weight:700;color:var(--yellow);text-transform:uppercase;letter-spacing:.5px;margin:0 0 4px}.rc-warning p{font-size:.87rem;color:var(--lightgray);line-height:1.55;margin:0}
...
<div class="rc-guide">
  <div class="rc-hero">
    ...
    <div class="rc-hero-stats">
      <div><div class="rc-num">Retries</div><div class="rc-lbl">Only — not dunning</div></div>
      <div><div class="rc-num">At risk</div><div class="rc-lbl">Revenue = all initial failures</div></div>
      <div><div class="rc-num">#</div><div class="rc-lbl">Which retry attempt succeeds</div></div>
    </div>
  </div>
  ...
  <nav class="rc-nav">
    ...
    <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-payments-hub-payment-processing"><span class="rc-snum">3</span>Payment processing</a>
    ...
    <a class="is-active" href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-payments-hub-retries"><span class="rc-snum">5</span>Payment retries</a>
