...
.rc-lp-pillar-tag {
  ...
  color: #FF5810; font-size: .75rem; font-weight: 800;
...
/* rc-btn-prev — (0,0,8,1); hex borders per Known Issue #52 */
...
/* rc-btn-path — (0,0,8,1) per Known Issue #44 */
...
.rc-guide a.rc-resource-link:hover {
  ...
  text-underline-offset: 3px; text-decoration-color: #FF5810 !important;
}
...
<div class="rc-guide">
  ...
  <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-payments-hub" class="rc-sticky-link"><span class="rc-step-badge">1</span> Getting started</a>
    ...
    <!-- Path navigation -->
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-payments-hub-payment-processing" class="rc-btn-prev">← Payment processing dashboard</a>
      <span class="rc-lp-nav-indicator">4 of 7</span>
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-payments-hub-payment-retries" class="rc-btn-path">Next: Payment retry recovery dashboard →</a>
    </div>
