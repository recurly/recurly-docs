...
/* ─── Program badge (OVERLAP with rp-plan — see styleguide) ─────────── */
...
.rp-nav-guide .rp-nav-nav a { display:inline-flex; align-items:center; gap:10px; padding:10px 18px; border-radius:12px; border:1px solid var(--lightgray); background:#fff; color:var(--darkgray); text-decoration:none; font-size:.88rem; font-weight:700; transition:border-color .2s, box-shadow .2s; }
.rp-nav-guide .rp-nav-nav a:hover { border-color:var(--yellow); box-shadow:0 2px 8px rgba(255,215,6,.2); color:var(--offblack); }
.rp-nav-guide .rp-nav-nav a.is-active { background:var(--yellow); border-color:var(--yellow); color:var(--offblack); box-shadow:0 2px 10px rgba(255,215,6,.25); }
...
/* ─── Card (OVERLAP with rp-card — see styleguide) ──────────────────── */
...
/* ─── 2-column + 3-column comparison grids + info items ─────────────── */
...
/* ─── Vertical step rail (NEW — propose adding to styleguide) ───────── */
...
/* ─── Tip callout (OVERLAP with rp-callout-tip — see styleguide) ─────── */
...
/* ─── Warning callout (OVERLAP with rp-callout-warning — see styleguide) */
...
.rp-nav-guide .rp-nav-link-btn { display:inline-flex; align-items:center; justify-content:center; padding:11px 18px; border-radius:10px; font-weight:700; font-size:.88rem; text-decoration:none; }
.rp-nav-guide .rp-nav-btn-prev { background:#fff; color:var(--darkgray); border:1px solid var(--lightgray); }
.rp-nav-guide .rp-nav-btn-next { background:var(--yellow); color:var(--offblack); border:1px solid var(--yellow); }
.rp-nav-guide .rp-nav-btn-disabled { background:var(--brightgray); color:var(--gray); border:1px solid var(--lightgray); cursor:default; }
.rp-nav-guide .rp-nav-link-btn { gap:8px; background:var(--yellow); color:var(--offblack); margin:0 8px 8px 0; }
.rp-nav-guide .rp-nav-link-sec { background:var(--offwhite); color:var(--darkgray); border:1px solid var(--lightgray); }

/* ─── Inline link auto-styling ──────────────────────────────────────── */
.rp-nav-guide a:not(.rp-nav-nav a):not(.rp-nav-btn-prev):not(.rp-nav-btn-next):not(.rp-nav-link-btn) {
  color:var(--tangerine); font-weight:700; text-decoration:none;
}
.rp-nav-guide a:not(.rp-nav-nav a):not(.rp-nav-btn-prev):not(.rp-nav-btn-next):not(.rp-nav-link-btn):hover {
...
<div class="rp-nav-guide">
  ...
  <div class="rp-nav-sec">
    ...
    <div class="rp-nav-card">
      <h3 class="rp-nav-subhead">🧩 The problem it solves</h3>
    ...
    <h3 class="rp-nav-subhead">🗺️ What's inside</h3>
    ...
    <h3 class="rp-nav-subhead">✅ Before you move on</h3>
    ...
    <h3 class="rp-nav-subhead" style="margin-top:28px;">📚 Additional resources</h3>
