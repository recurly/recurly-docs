...
<div class="rc-guide">
  ...
  <div class="rc-sec">
    ...
    <img src="https://files.readme.io/ea22de0f101e14451f795623abc56a40f45d4f4a6fb18edbaf367c0b7c5650d1-Overview_Dashboard.png" style="width:100%;border-radius:14px;border:1px solid var(--lightgray);margin-bottom:24px;" />
    ...
    <div class="rc-tip">
      ...
      🔰 Learn more about <strong>Kount fraud prevention <a href="https://docs.recurly.com/recurly-subscriptions/docs/kount" target="_blank" style="color:var(--orange);font-weight:700; rel="noopener noreferrer">here</a></strong>.<br>
				<strong>🔄 Account Updater not enabled yet?</strong> Learn what it means and how to make it work for you <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-retain-account-updater" target="_blank" style="color:var(--orange);font-weight:700; rel="noopener noreferrer">here</a></strong>.
</p></div>
      </div></div>
