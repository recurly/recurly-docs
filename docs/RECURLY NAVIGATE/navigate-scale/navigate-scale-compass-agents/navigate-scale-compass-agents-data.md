  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-announce-bar rc-active">
      <div class="rc-announce-inner">
        ...
        <strong>Customer training:</strong> Get to know Recurly's agentic AI — watch the on-demand customer training for all six skill demos, discussion, and answers to audience questions.
    ...
    <details class="rc-sticky-nav-wrap" open>
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-compass-agents-data" class="rc-sticky-link rc-sticky-link-active">
          <img src="https://files.readme.io/070e914d23dead09604d5f96b8769c88b8aae704ebd4505415e5854011030110-Black_Navigate_Home_Pin_1.png" alt=""> Data Agent
        </a>
        ...
        <details class="rc-skill" id="skill-generate-an-export" open>
          ...
          <div class="rc-skill-body">
            ...
            <div class="rc-accent-card rc-accent-scale">
              ...
              <p class="rc-tryit-note"><strong>Heads up:</strong> these pull from your live data, so run them in your own Recurly account to see real results.</p>
            </div>
