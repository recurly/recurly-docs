  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-announce-bar rc-active">
      <div class="rc-announce-inner">
        ...
        <strong>Customer training:</strong> Watch <strong>Get to know Recurly's agentic AI</strong> on-demand for all six demos, expert commentary, and audience Q&A. 
    ...
    <div class="rc-hero">
      ...
      <p>You've completed the Compass agents &amp; skills learning path. Check what stuck, try your own prompts, and make Compass your new home for discovery, coding assistance, plan deployment, and day-to-day tasks.</p>
    </div>
