...
.rc-stat-tile-num { font-size: 2rem; font-weight: 800; color: #008CFF; line-height: 1; margin-bottom: 4px; }
...
.rc-feature-card:hover { border-color: #008CFF; box-shadow: 0 4px 16px rgba(0,140,255,0.15); transform: translateY(-2px); }
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-hero">
      ...
      <div class="rc-lp-hero-title"><h1>Global payments expansion: Currency &amp; payment methods</h1></div>
      <p>The single biggest lever for conversion in a new market isn't a discount &mdash; it's letting customers pay the way they already do.</p>
    </div>
    ...
    <details class="rc-sticky-nav-wrap" open>
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-currency" class="rc-sticky-link rc-sticky-link-active">
          <img src="https://files.readme.io/070e914d23dead09604d5f96b8769c88b8aae704ebd4505415e5854011030110-Black_Navigate_Home_Pin_1.png" alt=""> Currency &amp; payment methods
        </a>
    ...
    <div class="rc-lp-section">
      <h2><i class="fa-solid fa-coins rc-fa-section"></i> Why local currency and local methods win</h2>
      <p>Customers judge a checkout as foreign or familiar in seconds. A price in an unfamiliar currency or a payment method they don't recognize both read as friction, and friction shows up directly in conversion.</p>
    </div>

    <div class="rc-stat-strip">
      <div class="rc-stat-tile">
        <div class="rc-stat-tile-num">92%</div>
        <div class="rc-stat-tile-label">Prefer local currency</div>
        <div class="rc-stat-tile-context">Most customers prefer to buy in their own currency over a foreign one.</div>
      </div>
      <div class="rc-stat-tile">
        <div class="rc-stat-tile-num">30%</div>
        <div class="rc-stat-tile-label">Abandon USD-only pricing</div>
        <div class="rc-stat-tile-context">Nearly a third of customers will abandon a purchase priced only in USD.</div>
      </div>
      <div class="rc-stat-tile">
        <div class="rc-stat-tile-num">+12%</div>
        <div class="rc-stat-tile-label">Revenue lift</div>
        <div class="rc-stat-tile-context">Merchants see a revenue increase when they offer relevant local payment methods.</div>
      </div>
    </div>

    <div class="rc-lp-section">
      <h2><i class="fa-solid fa-wallet rc-fa-section"></i> Local methods worth knowing</h2>
      <p>Card networks dominate in the US, but many markets lean on other rails entirely. A few examples of local methods that carry meaningful volume in their home markets:</p>
    </div>

    <div class="rc-card-grid">
      <div class="rc-feature-card">
        <div class="rc-feature-icon"><i class="fa-solid fa-building-columns"></i></div>
        <h4>SEPA Direct Debit</h4>
        <p>A euro-denominated direct debit scheme used across the SEPA zone. Popularity varies widely by country &mdash; strong in the Netherlands and Belgium, lighter in Italy.</p>
        <span class="rc-feature-tag">Europe</span>
      </div>
      <div class="rc-feature-card">
        <div class="rc-feature-icon"><i class="fa-solid fa-mobile-screen"></i></div>
        <h4>iDEAL</h4>
        <p>The default online payment method in the Netherlands. Most Dutch shoppers expect to see it at checkout.</p>
        <span class="rc-feature-tag">Netherlands</span>
      </div>
      <div class="rc-feature-card">
        <div class="rc-feature-icon"><i class="fa-solid fa-bolt"></i></div>
        <h4>Pix</h4>
        <p>Brazil's instant payment scheme. Widely adopted for its speed and lack of fees for individual customers.</p>
        <span class="rc-feature-tag">Brazil</span>
      </div>
      <div class="rc-feature-card">
        <div class="rc-feature-icon"><i class="fa-solid fa-arrows-rotate"></i></div>
        <h4>UPI AutoPay</h4>
        <p>India's bank-mandate rail for recurring payments. Built to meet the Reserve Bank of India's recurring-payment rules.</p>
        <span class="rc-feature-tag">India</span>
      </div>
    </div>
    ...
    <div class="rc-callout rc-callout-tip">
      ...
      <div class="rc-callout-body">
        <strong>Currency and payment method are two separate switches</strong>
        <p>Enabling a currency doesn't automatically enable the local payment methods tied to it. Recurly supports 140+ currencies, but each payment method still needs its own setup at the gateway and plan level. Check gateway support before you promise a launch date.</p>
      </div>
    </div>
    ...
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-mor" class="rc-btn-prev">&larr; LCA vs. MoR</a>
      <span class="rc-lp-nav-indicator">2 of 4</span>
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-compliance" class="rc-btn-path">Next: Compliance &amp; language &rarr;</a>
    </div>
