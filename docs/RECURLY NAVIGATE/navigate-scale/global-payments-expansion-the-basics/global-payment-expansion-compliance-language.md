...
/* ACCENT CARDS */
.rc-accent-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin: 0 0 32px; }
.rc-accent-card { background: var(--offwhite); border: 1px solid var(--lightgray); border-radius: 12px; padding: 22px 24px; margin: 0; }
.rc-accent-card.rc-accent-scale { border-left: 4px solid #008CFF; }
.rc-accent-card h4 { font-size: .95rem; font-weight: 800; color: var(--offblack); margin: 0 0 12px; display: flex; align-items: center; gap: 8px; }
.rc-accent-card ul { font-size: .86rem; color: var(--gray); line-height: 1.7; padding-left: 18px; margin: 0; }
.rc-accent-card ul li { margin-bottom: 6px; }
...
@media(max-width:768px){
  ...
  .rc-accent-grid { grid-template-columns: 1fr; }
  .rm-Markdown.markdown-body .rc-guide a.rc-btn-prev:not([class*="Button"]):not(.rp-anchor):not(.rp-toc-pill):not(.rp-btn),
...
<div class="rc-guide">
  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-hero">
      ...
      <div class="rc-lp-hero-title"><h1>Global payments expansion: compliance &amp; language</h1></div>
      <p>What to check, region by region, before you flip the switch on a new market.</p>
    </div>
    ...
    <details class="rc-sticky-nav-wrap" open>
      ...
      <div class="rc-nav-drawer"><div class="rc-nav-drawer-inner"><div class="rc-nav-links">
        ...
        <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-compliance" class="rc-sticky-link rc-sticky-link-active">
    ...
    <div class="rc-lp-section">
      <h2><i class="fa-solid fa-clipboard-check rc-fa-section"></i> Three areas to check before launch</h2>
      <p>Compliance requirements vary by country, but they generally fall into three buckets. Work through all three before you commit to a launch date &mdash; each one can quietly delay a rollout if it's caught late.</p>
    </div>

    <div class="rc-accent-grid">
      <div class="rc-accent-card rc-accent-scale">
        <h4><i class="fa-solid fa-gavel"></i> Regulatory &amp; licensing</h4>
        <ul>
          <li>Some countries require a local PSP license, money transmitter license, or legal entity before you can process payments.</li>
          <li>Pre-renewal notification rules differ by region (EU/UK Consumer Contracts Regulations, for example).</li>
          <li>Check whether your existing licenses are recognized abroad or need separate registration.</li>
        </ul>
      </div>
      <div class="rc-accent-card rc-accent-scale">
        <h4><i class="fa-solid fa-file-invoice-dollar"></i> Tax &amp; reporting</h4>
        <ul>
          <li>Understand local VAT, GST, or similar obligations &mdash; registration is often required past a revenue threshold.</li>
          <li>Watch for withholding tax on cross-border payments and local financial reporting rules.</li>
          <li>Outside the US and Canada, customers generally expect tax-inclusive pricing, not tax added at checkout.</li>
        </ul>
      </div>
      <div class="rc-accent-card rc-accent-scale">
        <h4><i class="fa-solid fa-lock"></i> Data privacy &amp; security</h4>
        <ul>
          <li>Local data protection laws apply on top of PCI DSS (GDPR in Europe, LGPD in Brazil, and similar regimes elsewhere).</li>
          <li>Some countries require payment data to be stored locally &mdash; confirm data residency rules before launch.</li>
        </ul>
      </div>
    </div>

    <div class="rc-lp-section">
      <h2><i class="fa-solid fa-language rc-fa-section"></i> Language isn't always optional</h2>
      <p>If you translate your product, translate your subscription emails and invoices too. In several markets, local-language billing documents aren't a nicety, they're the law: France requires invoices in French, Quebec's Charter of the French Language applies the same rule, and Belgium requires one of three official languages depending on the region. Check the language requirement alongside the tax requirement &mdash; they're often set by the same regulation.</p>
    </div>

    <div class="rc-callout rc-callout-caution">
      <div class="rc-callout-icon"><i class="fa-solid fa-triangle-exclamation"></i></div>
      <div class="rc-callout-body">
        <strong>This isn't legal advice</strong>
        <p>Treat this page as a starting checklist, not a compliance sign-off. Tax and regulatory requirements change and vary by business type &mdash; confirm specifics with your legal and tax teams before launching in a new market.</p>
      </div>
    </div>
    ...
    <div class="rc-lp-nav">
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-currency" class="rc-btn-prev">&larr; Currency &amp; payment methods</a>
      <span class="rc-lp-nav-indicator">3 of 4</span>
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-scale-global-payments-review" class="rc-btn-path">Next: Review &amp; resources &rarr;</a>
    </div>
