---
title: Navigate Code Testing Home Page
deprecated: false
hidden: true
metadata:
  robots: index
...
.rc-guide a.rc-sticky-link:hover { background: var(--offblack); color: var(--yellow) !important; }
.rc-sticky-link img { width: 15px; height: 15px; object-fit: contain; }
.rc-sticky-link-active { background: rgba(0,0,0,0.12); font-weight: 800; }
.rc-guide a.rc-sticky-link-active:hover { background: var(--offblack); color: var(--yellow) !important; }
...
.rc-btn-secondary { background: transparent; color: var(--offblack) !important; text-decoration: none !important; padding: 10px 24px; border-radius: 10px; font-weight: 700; font-size: .9rem; border: 2px solid var(--offblack); border-bottom: 2px solid var(--offblack) !important; white-space: nowrap; transition: all .2s; }
.rc-guide a.rc-btn-secondary:hover { background: var(--offblack); color: var(--yellow) !important; border-bottom: 2px solid var(--offblack) !important; }
...
.rc-guide a.rc-footer-link:hover { color: var(--offblack) !important; }
