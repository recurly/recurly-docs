...
<div class="rc-guide">
 ...
 <!-- SECTION: REFLECTION -->
    <div class="rc-lp-section">
      <h2><i class="fa-solid fa-head-side-gear rc-fa-section"></i> Reflect before you move on</h2>
 ...
 <!-- SECTION: PHASE TWO CTA -->
    ...
    <div class="rc-lp-nav">
      ...
      <a href="https://docs.recurly.com/recurly-subscriptions/docs/navigate-launch-phase-two" class="rc-btn-path">Continue to Phase Two: Mastering metrics →</a>
    </div>
