---
title: Navigate Resource download
deprecated: false
hidden: true
metadata:
  robots: index
...
/* ── STICKY NAV (LAUNCH PILLAR THEMED) ── */
...
.rc-hero {
  ...
  color: #fff; padding: 48px 40px 44px; text-align: center; border-radius: 16px; margin-bottom: 20px;
}
...
/* ── CALLOUT TIP ── */
.rc-callout { border-radius: 10px; padding: 16px 20px; margin: 20px 0 40px; display: flex; gap: 14px; align-items: flex-start; }
  ...
  <div class="rc-content-wrap">
    ...
    <div class="rc-hero">
      ...
      <div class="rc-home-title-block">
        <h1>Navigate resource guide</h1>
        <p>A handy cheat sheet for finding what you need - fast. All your essential Recurly links, tools, and support resources.</p>
      </div>
    </div>
    ...
    <div class="rc-callout rc-callout-tip">
      ...
      <div class="rc-callout-body">
        ...
        <p>Add <strong>RecurlyNavigate@Recurly.com</strong> to your contacts for all program updates, announcements, and resources.</p>
      </div>
    </div>
      ...
      <div class="rc-nav-drawer">
        <div class="rc-nav-drawer-inner">
          <div class="rc-nav-links">
            ...
            <a href="#essential" class="rc-sticky-link rc-sticky-link-active">
              <img src="https://files.readme.io/070e914d23dead09604d5f96b8769c88b8aae704ebd4505415e5854011030110-Black_Navigate_Home_Pin_1.png" alt="Pin"> Essential Navigate resources
            </a>
    ...
    <div class="rc-lp-section" id="essential">
      ...
      <p>Educational resources designed to help you grow, retain, and scale your business.</p>
      
      <div class="rc-card-grid">
        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-circle-play"></i></div>
          <h4>Navigate Events Hub</h4>
          <p>Bookmark the hub for all upcoming and on-demand webinars to help you scale.</p>
        ...
        <div class="rc-feature-card">
          ...
          <p>Stay informed month-to-month with the latest resources and scheduled events.</p>
          <a href="#" target="_blank" rel="noopener noreferrer">View calendar ↗</a>
        </div>

        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-robot"></i></div>
          <h4>Compass AI Answers</h4>
          <p>An AI-powered suite embedded throughout Recurly, offering insights, answers, and playbooks. Located in the bottom right corner of your app.</p>
    ...
    <div class="rc-lp-section" id="recurly">
      ...
      <p>Stay up-to-date with comprehensive guides, API references, and product updates.</p>
      
      <div class="rc-card-grid">
        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-folder-open"></i></div>
          <h4>Recurly Resource Center</h4>
          <p>Explore industry news, product updates, blog posts, and more.</p>
          <a href="#" target="_blank" rel="noopener noreferrer">Visit Resource Center ↗</a>
        </div>

        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-regular fa-file-lines"></i></div>
          <h4>Recurly Docs</h4>
          <p>Comprehensive guides, API references, and best practices across all our products.</p>
          <a href="#" target="_blank" rel="noopener noreferrer">Read the docs ↗</a>
        </div>

        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-bullhorn"></i></div>
          <h4>Updates & status</h4>
          <p>Subscribe to our newsletters for product announcements and access our 24/7 status page.</p>
          <a href="#" target="_blank" rel="noopener noreferrer">Subscribe here ↗</a>
        </div>
      </div>
    </div>
    ...
    <div class="rc-lp-section" id="support">
      ...
      <p>Whether you have a quick question or need deeper guidance, we are here to help.</p>
      
      <div class="rc-card-grid">
        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-globe"></i></div>
          <h4>Global Office Hours</h4>
          <p>Small group sessions allowing for one-to-one, expert support with our CSMs.</p>
          <a href="https://navigate.recurly.com/global-office-hours/" target="_blank" rel="noopener noreferrer">Book time ↗</a>
        </div>
        ...
        <div class="rc-feature-card">
          ...
          <a href="mailto:support@recurly.com">support@recurly.com →</a>
        </div>

        <div class="rc-feature-card">
          <div class="rc-feature-icon"><i class="fa-solid fa-ticket"></i></div>
          <h4>Support Web Portal</h4>
          <p>Access the portal to submit and manage support tickets, or use live chat for quick help.</p>
          <a href="https://support.recurly.com/hc/en-us" target="_blank" rel="noopener noreferrer">Visit portal ↗</a>
        </div>
      </div>
    </div>
