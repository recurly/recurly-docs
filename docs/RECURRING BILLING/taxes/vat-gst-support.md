...
Integrating with the latest <a href="https://docs.recurly.com/recurly-subscriptions/docs/vertex" target="_blank">Vertex version</a> allows you to display Brazilian tax IDs CPF/CNPJ and informational tax on a subscriber's invoice. Once configured in your Vertex account, Recurly automatically pulls this data and displays it on the invoice.
