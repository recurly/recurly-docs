...
> 🚧 **Invoice number jump**
>
> Activating Credit Invoices might cause a leap in invoice numbers. This is due to Recurly transitioning any uninvoiced carryforward credits to new credit invoices with the origin of carryforward\_credit.

### Transitioning existing carryforward credits

Before the Credit Invoices feature, Recurly issued credits on the same invoice as charges. If the entire credit wasn't used, a new uninvoiced credit was created. With Credit Invoices if the entire credit isn't used, these "carryforward" credits are automatically transitioned to the new credit invoice structure. These invoices, marked with an origin of **carryforward\_credit**, represent already issued credits and aren't emailed to customers.
