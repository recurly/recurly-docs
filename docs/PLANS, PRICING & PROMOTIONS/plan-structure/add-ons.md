...
<div class="rp-page">
  <div class="rp-overview">Add-ons let you attach additional charges to a subscription plan — billed each period alongside the base charge. Whether you're building a unique add-on from scratch or reusing an item from your catalog across multiple plans, Recurly gives you the flexibility to package your products exactly the way your business needs.</div>
...
<div class="rp-benefits">
  ...
  <div class="rp-benefit">
    <div class="rp-benefit-icon"><i class="fa-solid fa-calendar" aria-hidden="true"></i></div>
...
<span class="rp-zoom">
  <a class="rp-zoom-label" href="#zoom-addon-type-selector">
    <img class="rp-zoom-img" src="https://files.readme.io/5916c04-Screenshot_2023-12-05_at_1.58.47_PM.png" alt="Add-on type selection — unique to plan or from item catalog" />
  </a>
  <a id="zoom-addon-type-selector" class="rp-zoom-overlay" href="#rp-close">
...
<span class="rp-zoom">
  <a class="rp-zoom-label" href="#zoom-addon-properties">
    <img class="rp-zoom-img" src="https://files.readme.io/8c21c4e0ebd874c93570696c830ee4b1e68664d47d108291d1fc23ff910077c1-image.png" alt="Add-on properties form" />
  </a>
  <a id="zoom-addon-properties" class="rp-zoom-overlay" href="#rp-close">
