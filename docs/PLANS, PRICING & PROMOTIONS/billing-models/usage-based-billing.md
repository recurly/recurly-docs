...
The exports will include tier_type but not detailed tiers pricing information. For access to specific tiers for a plan, subscription, or usage record, consider using the API responses.
...
- When you zero-out the usage for a current cycle, a new_usage_notification webhook will be sent to update your usage records.
- When you refund a usage-based add-on, a new_usage_notification webhook will be sent to let you know what usage record was created.
- If Recurly creates usage on your behalf in a refund, a new_usage_notification will be sent. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3799415-Image_2020-07-06_at_2.34.44_PM.png",
        "Image 2020-07-06 at 2.34.44 PM.png",
        831
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "New Plan Page - Add-On Choices"
    }
  ]
}
[/block]
...
[block:parameters]
{
  "data": {
    ...
    "0-0": "Add-On Name",
    "0-1": "Video Streaming",
    "0-2": "The name of your add-on, seen on Checkout, the Hosted Payment Page and invoice line item",
    "1-0": "Add-On Code",
    "1-1": "video_streaming",
    "1-2": "The product code for your add-on, seen in exports and used in the API",
    "2-0": "Accounting Code",
    "2-1": "VS1000239",
    "2-2": "Optional accounting code to help your finance team account for the revenue in the right ledger",
    "3-0": "Tax Type / Tax Code",
    "3-1": "\"Digital Product\" or \"D0000000\"",
    "3-2": "Those collecting EU VAT or using the AvaTax integration can define their usage product for appropriate taxation",
    "4-0": "Charge Model",
    "4-1": "\"Price per Unit\" or \"Percentage of an Amount\"",
    "4-2": "Whether you want to define a price or percentage. Once you set a model, you cannot change it on the Edit Plan page. You will need to remove the add-on and add a new one.",
    "5-0": "Measured Unit",
    "5-1": "Bandwidth (GB)",
    "5-2": "The unit of measure. Provides a display for Checkout or Hosted Payment Page pricing and allows you to track the same unit type across multiple add-ons and plans.",
    "6-0": "Pricing Model (Tier Type)",
    "6-1": "Fixed, Tiered, Volume, Stairstep",
    "6-2": "The pricing model to use for charges. For more info, [click here](https://docs.recurly.com/docs/billing-models#section-quantity-based).  \n  \nReferred to as Tier Type in developer docs and cannot be  used when Charge Model is Percentage.",
    "7-0": "Price",
    "7-1": "$0.50 USD, €0.45 EUR",
    "7-2": "The price per unit charged. This can be up to 9 decimal places.",
    "8-0": "Tiers",
    "8-1": "An array of tiers and prices to be used in combination with the Tier Type",
    "8-2": "The tiers and currencies that are used to charge for the usage logged.",
    "9-0": "Percentage",
    "9-1": "2.36%",
    "9-2": "The percentage taken of the monetary amount of usage tracked. This can be up to 4 decimal places. Percentage tiers and volume are supported.",
    "10-0": "Make this add-on optional to the customer",
    "10-1": "Boolean checkbox",
    "10-2": "Whether the add-on is optional to the customer on Checkout or the Hosted Payment Page. Usage-based add-ons default to required."
  },
  "cols": 3,
  "rows": 11,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6c02444-Screen_Shot_2022-11-09_at_9.28.44_AM.png",
        "Screen Shot 2022-11-09 at 9.28.44 AM.png",
        ""
      ],
      "align": "center",
      "border": true
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0c47dea-Screen_Shot_2023-04-10_at_8.58.37_PM.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7SUwP0NQNiDQ8K4fQ2bB_mu-creation-in-plan.png",
        "mu-creation-in-plan.png",
        "1384"
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "Create a Measured Unit when Creating an Add-on"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/AHQbvJl2RfWr5SLPzhxV_mu-page.png",
        "mu-page.png",
        "1908"
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "Create, View, Edit and Delete Measured Units from the Measured Units Page"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d29709f-Image_2020-07-08_at_11.52.49_AM.png",
        "Image 2020-07-08 at 11.52.49 AM.png",
        560
      ],
      "align": "center",
      "sizing": "50% ",
      "border": true,
      "caption": "Example Hosted Payment Page for a Usage-Based Plan"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ec95e6-Image_2020-07-08_at_12.18.35_PM.png",
        "Image 2020-07-08 at 12.18.35 PM.png",
        1059
      ],
      "align": "center",
      "sizing": "50% ",
      "border": true,
      "caption": "New Subscription with Usage-Based Add-Ons and Add-ons"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/gbic9xnES6G4I1DMlNND_normal-first-invoice.png",
        "normal-first-invoice.png",
        "1244"
      ],
      "align": "center",
      "sizing": "50% ",
      "border": true,
      "caption": "Example First Invoice without Usage-Based Add-ons"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3LZb3lqTF2YGpISQi3Yd_trial-invoice.png",
        "trial-invoice.png",
        "1236"
      ],
      "align": "center",
      "sizing": "50% ",
      "border": true,
      "caption": "Example Trial Invoice with Usage-Based Add-ons"
    }
  ]
}
[/block]
...
You can edit usage records that haven't been billed yet. If the usage has been billed, consider issuing a refund, credit, or creating a Usage Correction. Note that once the usage is billed, you can only edit the "merchant_tag" field. 
...
_The invoice discounts will follow as_
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc5468a-image.png",
        null,
        ""
      ],
      "align": "left",
