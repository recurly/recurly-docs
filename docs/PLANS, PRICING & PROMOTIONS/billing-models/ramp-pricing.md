...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0d6fd0e-Step_1.png",
        "Step 1.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/776f024-Step_2.png",
        "Step 2.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/feaf205-Step_3.png",
        "Step 3.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2885fbc-Step_4.png",
        "Step 4.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a5cf870-Step_5.png",
        "Step 5.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/113d4a9-Step_6.png",
        "Step 6.png",
        ""
      ],
      "align": "center",
...
> 
> [block:image]{"images":[{"image":["https://files.readme.io/d297244-Plan_with_Multiple_Currencies.png","Plan with Multiple Currencies.png",""],"align":"center","sizing":"75% ","border":true}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0f60395-sub_create_-_step1.png",
        "sub create - step1.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3840d4e-sub_create_-_step1a.png",
        "sub create - step1a.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/026956a-sub_create_-_step2.png",
        "sub create - step2.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/be53cb3-sub_create_-_step3.png",
        "sub create - step3.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e1fa048-sub_create_-_step4.png",
        "sub create - step4.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/307ffa0-sub_create_-_step6.png",
        "sub create - step6.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/39f09af-edit_-_step_1.png",
        "edit - step 1.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4144501-edit_-_step_2.png",
        "edit - step 2.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/322092c-edit_-_step_3.png",
        "edit - step 3.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/eb31281-edit_-_step_4.png",
        "edit - step 4.png",
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/929dcb7-edit_-_step_5.png",
        "edit - step 5.png",
        ""
      ],
      "align": "center",
...
_Example: If a customer is on a lower-priced plan and has completed the intro ramp interval pricing, and is now paying full price for their subscription. If the customer wishes to upgrade their subscription to a higher-priced plan, you can switch them to that subscription at the full price point, bypassing the initial ramp intervals._
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/34de9d9-Changing_plans_on_a_subscription.png",
        "Changing plans on a subscription.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/45e601c-Ramp_Sub_with_Trial.png",
        "Ramp Sub with Trial.png",
        ""
      ],
      "align": "center",
      "sizing": "75% ",
...
- New email parameters supporting this template include: {{next_ramp_interval_start_date}}, and {{next_ramp_interval_price}}.
...
- Exports 'Subscriptions', 'Subscription - History', and 'Subscriptions - Churned' now include two new columns, namely: pricing_model and current_ramp_id.
