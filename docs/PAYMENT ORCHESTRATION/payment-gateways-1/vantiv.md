...
[block:parameters]
{
  "data": {
    ...
    "1-1": "Transaction Processing (Verify, Purchase, Separate Authorize and Capture, Void, Refund)",
    "2-0": "Supported payment types",
    "2-1": "Credit Card, Apple Pay",
    "3-0": "Supported card brands",
    "3-1": "Visa, MasterCard, Amex, Discover, JCB, Diners Club",
    ...
    "6-1": "US and Canada",
    "7-0": "Currencies",
    "7-1": "See <a href=\"https://docs.recurly.com/docs/currency-support-by-gateway\" target=\"_blank\">all available.</a>"
  },
  "cols": 2,
  "rows": 8,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/faa14a7-image.png",
        null,
        "WorldPay Account Updater Interface"
      ],
      "align": "center",
      "border": true
    }
