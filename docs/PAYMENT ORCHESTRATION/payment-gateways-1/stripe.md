...
| Stripe Elements                     | Cards, Apple Pay, Google Pay, Link Pay (Cards), Cash App Pay, Revolut (UK/EU only), ACH, SEPA, BACS, BECS. Financial Connections is required for verifying bank information.             |
