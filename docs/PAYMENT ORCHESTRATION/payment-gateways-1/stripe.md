...
* **Integration Style**: Since India requires all CIT/ Signups to go through 3DS, it is recommended to combine your subscription creation and customer interactions into the same flow instead of adding the billing information and setting. up a subscription in two steps.
