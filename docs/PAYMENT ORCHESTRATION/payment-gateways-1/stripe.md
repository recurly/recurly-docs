...
| **Other Gateway Feature Support**   | Level 2 Data, Payment Elements, Payment Method Tokens, India E-Mandates / [RBI Compliance](https://docs.recurly.com/recurly-subscriptions/docs/rbi-regulations-update#/)                                                                                                                                                                                      |
...
* **Integration Style**: Since India requires all CIT/ Subscription Signups to go through 3DS, it is recommended to **combine** your subscription creation and customer interactions into a single step instead of adding the billing information via verification and setting. up a subscription in two steps.
