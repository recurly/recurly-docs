...
[block:parameters]
{
  "data": {
    ...
    "1-1": "Transaction Processing: Purchase, Auth and Capture, Void, Refunds, AVS Checks",
    "2-0": "Supported Payment Types",
    "2-1": "Credit/Debit Card, Apple and Google Pay  \n  \n- Apple Pay is not supported with TSYS/Vital acquirer",
    "3-0": "Supported Card Brands",
    "3-1": "Visa, MasterCard, American Express, Discover, Diners Club, JCB, Union Pay",
