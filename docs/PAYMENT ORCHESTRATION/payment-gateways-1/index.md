...
excerpt: >-
  Overview of Recurly's supported payment gateways, with links to setup
...
---
<div class="rp-page">
<div class="rp-overview">Recurly integrates with a broad range of payment gateways so you can route transactions through the provider that best fits your business model, geographic footprint, and payment method mix. Select a gateway below to access its setup and configuration guide.</div>
<div class="rp-plan"><i class="fa-solid fa-key" aria-hidden="true"></i> Available on all Recurly plans</div>
<div class="rp-toc">
<a class="rp-toc-pill" href="#definition"><span class="rp-toc-num">1</span>Definition</a>
<a class="rp-toc-pill" href="#key-benefits"><span class="rp-toc-num">2</span>Key benefits</a>
<a class="rp-toc-pill" href="#supported-gateways"><span class="rp-toc-num">3</span>Supported gateways</a>
</div>
</div>

# Definition

<div class="rp-definition">Payment gateways are the secure conduits that carry payment data from your customer to the payment processor and back. Recurly supports a wide selection of reputable gateways — each one configurable directly from your dashboard — so you can match your payment infrastructure to your operational needs, regional requirements, and preferred payment methods.</div>
...
<span>Choose from a broad range of reputable gateways to match your business model, geographic focus, and payment method requirements.</span>
</div>
<div class="rp-benefit">
<div class="rp-benefit-icon"><i class="fa-solid fa-lock" aria-hidden="true"></i></div>
<strong>Secure transactions</strong>
<span>Every supported gateway ships with robust security controls that protect sensitive payment data throughout the transaction lifecycle.</span>
</div>
<div class="rp-benefit">
<div class="rp-benefit-icon"><i class="fa-solid fa-earth-americas" aria-hidden="true"></i></div>
<strong>Global reach</strong>
<span>Serve customers worldwide with multi-currency and regional payment support across Recurly's gateway network.</span>
</div>
<div class="rp-benefit">
<div class="rp-benefit-icon"><i class="fa-solid fa-plug" aria-hidden="true"></i></div>
<strong>Seamless integration</strong>
<span>Each gateway connects to Recurly through a consistent setup flow — configure credentials, enable the gateway, and start processing with minimal friction.</span>
</div>
<div class="rp-benefit">
<div class="rp-benefit-icon"><i class="fa-solid fa-arrow-trend-up" aria-hidden="true"></i></div>
<strong>Optimized payment flow</strong>
<span>Take advantage of gateway-specific features — smart retries, account updaters, and alternative payment methods — to reduce declines and improve authorization rates.</span>
</div>
</div>
