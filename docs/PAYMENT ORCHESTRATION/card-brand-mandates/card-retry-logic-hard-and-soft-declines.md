...
Only "soft" declines (Insufficient Funds, as an example) can be retried *and* only under strict guidelines from the card networks. Visa and Mastercard have different guidelines on the frequency of retries.
