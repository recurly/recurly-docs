...
[block:callout]
{
  "type": "warning",
  "title": "Early Access",
  "body": "EBANX gateway is currently in Early Access. Please reach out to your CSM or Recurly Support to enable this gateway."
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bf9e1bb-currencies.png",
        "currencies.png",
        1710,
        878,
        "#fafafa"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0ecd6ab-payment_methods.png",
        "payment_methods.png",
        1724,
        866,
        "#fafafa"
...
[/block]
For testing please use can EBANX [Test Credit Cards](https://developer.ebanx.com/docs/resources/testCreditCards) and [Test Customer Data](https://developer.ebanx.com/docs/resources/testCustomerData) 
