...
* Subscription item / add-ons are not supported at this time due to subscription-specific mandate creation requirements with UPI. You can read more about our specific [mandate tolerances](https://docs.recurly.com/recurly-subscriptions/docs/upi-autopay#/how-are-mandates-set-up) below.
