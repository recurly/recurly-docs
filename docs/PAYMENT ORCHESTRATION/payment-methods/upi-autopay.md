...
* Subscription item / add-ons are not supported at this time due to subscription-specific mandate creation requirements with UPI. See more information on mandate tolerances we make below.
