...
- **Braintree** prefixes must be 3, 7, or 12 characters, and may be modified from your set DBA. If your DBA does not meet these character limitations, it will be padded with spaces where possible.
