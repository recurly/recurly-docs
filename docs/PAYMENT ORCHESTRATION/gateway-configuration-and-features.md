---
title: Gateway configuration and features
excerpt: >-
  Engage in secure, adaptable, and efficient payment processing with Recurly's
  Gateway Configuration & Features. Discover a spectrum of functionalities
  crafted to support your business's diverse payment processing needs.
deprecated: false
hidden: false
metadata:
  title: ''
...
The Gateway Configuration & Features segment encompasses an array of configurations and functionalities available within Recurly to facilitate secure and efficient payment processing. From managing multiple gateways to custom routing and robust fraud management, this segment is engineered to provide a solid foundation for managing transactions, reducing risks, and enhancing the payment experience.
