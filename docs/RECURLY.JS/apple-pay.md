...
* **Browser / device support** – Customers using Recurly.js out of the box can use Safari (macOS 10.14.4+, iOS 12.2+) or another Apple Pay–capable browser/device. To use non-Safari browsers, please follow the documentation below under **Key details -> Non-Safari browsers**.
