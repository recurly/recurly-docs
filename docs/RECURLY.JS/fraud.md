...
First, you will need to collect device data <Anchor target="_blank" href="https://developer.paypal.com/braintree/docs/guides/client-sdk/setup/javascript/v3/">using the Braintree JavaScript client</Anchor>. This is required by Braintree.
