...
Open a free sandbox account at [https://app.recurly.com/signup](https://app.recurly.com/signup).

> 🚧 You must select a [data hosting region](https://docs.recurly.com/docs/data-hosting) for your new site when you open the sandbox account.
...
* Add a privacy policy URL that redirects to: [http://knowyourmeme.com/memes/doge](http://knowyourmeme.com/memes/doge)
* Add a terms of Service URL that is: [http://didthelakersgetswept.com/](http://didthelakersgetswept.com/)
