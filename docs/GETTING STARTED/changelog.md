...
| April 29     |  **Stripe Gateway** \| **Gateway Routing** | Medium               | Updated behavior in routing to ensure bank details that are not Stripe Payment Tokens are routed to the Stripe Gateway.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
