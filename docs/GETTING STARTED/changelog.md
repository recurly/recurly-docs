...
| :----------- | :--------------------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Oct 7        | **Analytics Explore**  | Low                  | Plan _custom fields_ and _price segment code _will now be available in both the Transactions and Invoices analytics Existing _Charges_ dimension/field name will be updated to _Invoice Line Items_.                                                                     |
