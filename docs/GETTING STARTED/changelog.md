...
| :----------- | :----------------------------------------------- | :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Apr 21       | **Payments Hub**                                 | Low                  | Payments Hub Dashboards — General Availability. Payments Hub is now available to all customers with the analytics user role permission. The new analytics experience includes five (5) dashboards that give you comprehensive visibility into your payment operations including Overview, Payment Processing, Account Updater, Payment Retry Recovery and Fraud Prevention. Reference: [https://docs.recurly.com/recurly-subscriptions/docs/payments-hub](https://docs.recurly.com/recurly-subscriptions/docs/payments-hub)Payments Hub documentation |
