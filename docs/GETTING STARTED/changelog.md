...
| Jul 1        | **Direct Debit Retry Enablement** | Low                  | Added broader support for Direct Debit retries for Adyen, Stripe, and GoCardless gateways for the following payment methods: BACS, BECS, SEPA, and ACH.                                                                                                                                                                                     |
