...
| Jan 13       | **Check Commerce Gateway**  | Low                  | We'll be exposing a field in gateway configuration for this gateway so that Merchants can set their highest transaction amount per their gateway contract. This should be set, else the maximum is 5000.00 per invoice.                                                                                                                               |
