...
| Oct 28       | **Stripe gateway**                 | Medium               | Stripe India Card processing is being generally released. Please see Special Handling notes for <a href="https://docs.recurly.com/recurly-subscriptions/docs/stripe#/special-payment-method-handling">Stripe India Cards</a> for more details.                                                                                                                                                                                                                                                                                                                                                                             |
