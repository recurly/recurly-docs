...
| :----------- | :---------------------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Oct 7        | **Analytics Explore**   | Low                  | Plan custom fields and price segment code will now be available in both the Transactions and Invoices analytics Explores so users can include these plan related fields to create reports, visualize the data and export the data.                                       |
| Oct 7        | **Cybersource gateway** | Medium               | Updated response handling for Smartpay processor. If you are using the Smartpay processor (and have it selected in the Cybersource dropdown), you will enjoy updated mappings related to Issuer Responses to improve hard and soft decline handling.                     |
