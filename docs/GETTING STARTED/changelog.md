...
| :----------- | :----------------------------- | :------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Nov 5        | **Data Exports**               | Low                  | A more modern, streamlined and easier to use UI will be available for all async data exports. These are the exports that can be requested on an ad hoc basis and downloaded once processed. The updated Exports Page UI will include easier to use filters and a more dynamic “time range” filter so users can customize their exports for download. |
...
| Oct 28       | **Stripe gateway**                 | Low                  | Stripe India Card processing is being generally released. Please see Special Handling notes for <a href="https://docs.recurly.com/recurly-subscriptions/docs/stripe#/special-payment-method-handling">Stripe India Cards</a> for more details.                                                                                                                                                                                                                                                                                                                                                                             |
