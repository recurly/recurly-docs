...
| :----------- | :--------------------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Oct 7        | **Analytics Explore**  | Low                  | Plan custom fields will now be available in both the Transactions and Invoices analytics Explores so users can include these plan related fields to create reports, visualize the data and export the data.                                                              |
