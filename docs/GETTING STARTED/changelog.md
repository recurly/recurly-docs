...
| :----------- | :---------------------: | :------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mar 3        | **Cybersource Gateway** | High                 | Added support for enforcing 3DS via `challengeCode`on certain Cybersource processors. Read more in our [Cybersource documentation](https://docs.recurly.com/docs/cybersource#/step-5-configure-your-3ds2-support-optional) . |
| Mar 3        |    Braintree Gateway    | High                 | Improved response code handling to retry additional soft-declined card transactions moving forward.                                                                                                                          |
| Mar 3        |      Vantiv Gateway     | High                 | Added new response codes to our system to ensure proper handling of new decline codes.                                                                                                                                       |
|              |                         |                      |                                                                                                                                                                                                                              |
