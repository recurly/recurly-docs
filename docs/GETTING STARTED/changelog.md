...
| :----------- | :----------------------------------------: | :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| April 22     |            **WorldPay Gateway**            | Medium               | Updated handling of MOTO transactions to correct intermittent payment failures.                                                                                                                                                                                                                                                                                         |
...
| April 18     |         **Recurly.js \| Checkout**         | HIgh                 | Updated handling of Recurly.js tokens to address an error in processing related to 3DS handling. This updated addresses direct Recurly.js integrations and usage of Checkout and Hosted Pages.                                                                                                                                                                          |
