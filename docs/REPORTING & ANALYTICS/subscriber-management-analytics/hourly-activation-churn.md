...
3. Apply filters to refine the data:
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/ae47489-Screen_Shot_2024-01-22_at_6.46.43_PM.png",null,null],"align":"center","border":true}]}[/block]
...
4. Review the **four key widgets** at the top:  
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0c2e58e-image.png",null,null],"align":"center","border":true,"caption":"**Click** on widget numbers to drill into account-specific data."}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/686ab54-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1b9c916-image.png",
        null,
        null
      ],
      "align": "center",
