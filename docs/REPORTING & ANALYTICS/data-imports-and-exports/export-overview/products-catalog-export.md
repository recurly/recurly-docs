...
| <span id="plan_interval_length">plan_interval_length</span>                   | 30                                                                                                                                        | The length of the interval type at which the plan is billed at.                                                                                                                                                                                                                                                       | numeric              |
| <span id="plan_total_billing_cycles">plan_total_billing_cycles</span>         | 12                                                                                                                                        | The total number of bill cycles that the plan will bill for 1 term.                                                                                                                                                                                                                                                   | numeric              |
...
| <span id="plan_trial_interval_length">plan_trial_interval_length</span>       | 12                                                                                                                                        | The length of the interval type that sets the duration of the trial.                                                                                                                                                                                                                                                  | numeric              |
...
| <span id="default_quantity">default_quantity</span>                           | 1                                                                                                                                         | Default quantity assigned to the product (default is 1)                                                                                                                                                                                                                                                               | numeric              |
