...
<Table align={["left","left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ textAlign: "left" }}>
        <span id="voided_at">voided\_at</span>
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        payment, gift\_card, write\_off, reduction, refund
      </td>
    ...
    <tr>
      <td style={{ textAlign: "left" }}>
        <span id="original_invoice_billed_date">original\_invoice\_billed\_date</span>
      </td>
    ...
    <tr>
      <td style={{ textAlign: "left" }}>
        <span id="original_invoice_status">original\_invoice\_status</span>
      </td>
    ...
    <tr>
      <td style={{ textAlign: "left" }}>
        <span id="applied_to_invoice_number">applied\_to\_invoice\_number</span>
      </td>
    ...
    <tr>
      <td style={{ textAlign: "left" }}>
        <span id="original_credit_payment_it">original\_credit\_payment\_id</span>
      </td>
