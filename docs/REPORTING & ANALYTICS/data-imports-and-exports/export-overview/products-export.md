...
| <span id="add_on_id">add_on_id</span>                                         | pink_sweater               | The api_id of the add_on                                                                                                                                                                                                                                                                                              | string               |
| <span id="item_code">item_code</span>                                         | PS1234                     | The Item Code maps to the user-specified unique ID of the item that was sold on this adjustment.                                                                                                                                                                                                                      | string               |
| <span id="product_type">product_type</span>                                   | enabled                    | The type of product                                                                                                                                                                                                                                                                                                   | string               |
| <span id="product_code">product_code</span>                                   | platinum                   | The unique Recurly identifier of the saved product used to create the product.                                                                                                                                                                                                                                        | string               |
...
| <span id="plan_trial_interval_length">plan_trial_interval_length</span>       | 12                         | The length of the interval type that sets the duration of the trial.                                                                                                                                                                                                                                                  | string               |
...
| <span id="currencies">currencies</span>                                       |                            | Json object of the currencies and associated prices                                                                                                                                                                                                                                                                   | string               |
| <span id="custom_fields">custom_fields</span>                                 |                            | Json object of any custom fields that are assigned to the product                                                                                                                                                                                                                                                     | string               |
