...
{
  "type": "danger",
  "body": "This feature should **not** be used in conjunction with Recurly sites running in **production mode** until it reaches General Availability. Feature should only be used in \"Sandbox\" and \"Development\" mode sites in order to preview the functionality"
}
[/block]
...
{
  "type": "warning",
  "body": "All available functionality listed is subject to change leading up to General Availability"
}
[/block]
