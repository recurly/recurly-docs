...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        New Actions area has clear cache, refresh data, download data, and track completion time for refresh options
      </td>

      <td style={{ textAlign: "left" }}>
        Actions area was not available in the Classic version.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Clear Cache & Refresh was available in the Classic version from the upper right corner of those dashboards..
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Currency Filters always appear, even if only one currency option is available.
      </td>

      <td style={{ textAlign: "left" }}>
        Currency Filters only displayed if more than one currency is available.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Ellipses with dropdown menu choices are not available in the Classic version.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Filters are grouped at the top left area of all dashboards and multiple view dashboards.
      </td>

      <td style={{ textAlign: "left" }}>
        Filters related to specific sections of the dashboards are found at that location.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Monthly Recurring Revenue (MRR) Drill Down option lets you view the MRR Accounts Drill report.
      </td>

      <td style={{ textAlign: "left" }}>
        Monthly Recurring Revenue (MRR) Drill Down option is not available in the Classic version.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Automatic Data Uploads occur multiple times a day. In addition, request a Clear Cache & Refresh from the Actions Area to start an upload.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Ability to Select, contrast, compare more than 2 plans. Can compare up to 12 plans at a time.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        Sort/Hide Data is not available in the Classic version.
      </td>
    </tr>
  </tbody>
</Table>
...
<Image title="download from actions.png" alt={598} src="https://files.readme.io/c82358e-download_from_actions.png">
  Clear Cache and Refresh from Actions Area
</Image>
...
<Image title="download link from widgets.png" alt={448} src="https://files.readme.io/623c09d-download_link_from_widgets.png">
  Clear Cache and Refresh from a Widget
</Image>
...
<Image title="analytics comparison date range .png" alt={1606} src="https://files.readme.io/8706534-analytics_comparison_date_range_.png">
...
<Image title="analytics compair filter with dropdown.png" alt={1516} src="https://files.readme.io/97a043c-analytics_compair_filter_with_dropdown.png">
  Subscriptions Filtered by Plans
</Image>
...
<Image title="analytics comaptison filters .png" alt={1528} src="https://files.readme.io/e864e53-analytics_comaptison_filters_.png">
  Filter Area
</Image>

2. If you do not want them to display, click the horizontal bar icon in the Actions area to select the Hide filters option.

<Image title="analytics hide filters  option.png" alt={540} src="https://files.readme.io/f6f6642-analytics_hide_filters_option.png">
  Action Area Shows Horizontal Bars
</Image>

3. Once you select Hide Filters, the Filter area will no longer be visible from the dashboard.

<Image title="analytics comaprison hidden filter area.png" alt={1560} src="https://files.readme.io/cabf880-analytics_comaprison_hidden_filter_area.png">
  Filter Area Hidden
</Image>
...
<Image title="download from actions.png" alt={598} src="https://files.readme.io/6c1d039-download_from_actions.png">
...
<Image title="billings totals overview.png" alt={2604} src="https://files.readme.io/33aa788-billings_totals_overview.png">
  Modern Dashboard Key Performance Indicators
</Image>
...
<Image title="analytics comparison mrr drill down bar chart.png" alt={2444} src="https://files.readme.io/4835115-analytics_comparison_mrr_drill_down_bar_chart.png">
  MRR Accounts Drill Down Option
</Image>
...
<Image title="analytics comparison mrr drill down table.png" alt={608} src="https://files.readme.io/72499fd-analytics_comparison_mrr_drill_down_table.png">
  Horizontal Ellipse in Far right Column
</Image>
...
<Image title="billings dat update widget.png" alt={642} src="https://files.readme.io/75ecb3a-billings_dat_update_widget.png">
  Widget Showing Latest Completed Upload
</Image>
...
<Image title="analytics compair filter with dropdown.png" alt={1516} src="https://files.readme.io/53ee4e6-analytics_compair_filter_with_dropdown.png">
  Select Top 5 Plans from Filter
</Image>
...
<Image title="analytics comparison plans filter.png" alt={1330} src="https://files.readme.io/2a3a94c-analytics_comparison_plans_filter.png">
  Filtered Plans from Select Plans List
</Image>
...
<Image title="analytics comparison unsorted bar chart.png" alt={2532} src="https://files.readme.io/1d11c32-analytics_comparison_unsorted_bar_chart.png">
  Bar Chart with Color-Coded Segments and Legends
</Image>
...
<Image title="analytics comparison sorted bar chart.png" alt={2538} src="https://files.readme.io/913170f-analytics_comparison_sorted_bar_chart.png">
  Grayed out Colors in Legend Hidden in Chart
</Image>
...
<Image title="analytics comparison sort on a table.png" alt={730} src="https://files.readme.io/c83eeb2-analytics_comparison_sort_on_a_table.png">
  Changing the Ascending/Descending Order in Tables
</Image>
