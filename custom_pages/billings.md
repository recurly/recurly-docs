...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4bab8ad-billings_totals_overview.png",
        "billings totals overview.png",
        2604,
        362,
        "#f5f6f6"
      ],
      "caption": "Billings Key Performance Indicators"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/999163b-billing_net_billings_bar_chart.png",
        "billing net billings bar chart.png",
        2616,
        1010,
        "#c2d4cb"
      ],
      "caption": "Neet Billings Totals"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d5c64f4-billing_new_vs_renewing_detail_.png",
        "billing new vs renewing detail .png",
        2606,
        826,
        "#f2f2f2"
      ],
      "caption": "New vs Renewing Billing Details"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc5aaeb-billing_by_state_map.png",
        "billing by state map.png",
        1290,
        1476,
        "#ecf1ed"
      ],
      "caption": "Billings by State Map"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6f58cee-billings_by_country_map.png",
        "billings by country map.png",
        1278,
        1494,
        "#f9faf9"
      ],
      "caption": "by Country MApBillings"
    }
  ]
}
[/block]